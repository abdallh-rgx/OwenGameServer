...
void Results::SendBattleRoyaleResult(const std::string& username, int placement, int elims, int xp, int startingCount) {
    ...
    int pointsGained = (elims * 20) + placementPoints;
...
void Results::SendEventMatchResults(const std::string& username, const std::string& eventId,
    ...
    const std::string url = BackendUrl + "/fortnite/api/game/v2/profile/" + username + "/dedicated_server/SendEventMatchResults?profileId=athena";
