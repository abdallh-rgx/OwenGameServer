...
// Parameters:
// EEnum_BoostJumpStates* BoostState (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_BoostJumpPack_C::DetermineStateToTransitionTo(EEnum_BoostJumpStates* BoostState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_BoostJumpPack_C_DetermineStateToTransitionTo Parms{};
...
void UGA_BoostJumpPack_C::ExecuteUbergraph_GA_BoostJumpPack(int32 EntryPoint)
{
	...
	Params::UGA_BoostJumpPack_C_ExecuteUbergraph_GA_BoostJumpPack Parms{};
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// EEJumpBoostPackState PreviousState (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EEJumpBoostPackState CurrentState_0 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_BoostJumpPack_C::HandleCurrentBoostStateChanged(EEJumpBoostPackState PreviousState, EEJumpBoostPackState CurrentState_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_BoostJumpPack_C_HandleCurrentBoostStateChanged Parms{};
...
void UGA_BoostJumpPack_C::HandleIdle(bool bForceEndHovering)
{
	...
	Params::UGA_BoostJumpPack_C_HandleIdle Parms{};
...
bool UGA_BoostJumpPack_C::IsUsingJetpackEffectActive()
{
	...
	Params::UGA_BoostJumpPack_C_IsUsingJetpackEffectActive Parms{};
...
void UGA_BoostJumpPack_C::K2_ActivateAbilityFromEvent(const struct FGameplayEventData& EventData)
{
	...
	Params::UGA_BoostJumpPack_C_K2_ActivateAbilityFromEvent Parms{};
...
void UGA_BoostJumpPack_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	Params::UGA_BoostJumpPack_C_K2_OnEndAbility Parms{};
...
// Parameters:
// EEJumpBoostPackState InPreviousState (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EEJumpBoostPackState InCurrentState (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_BoostJumpPack_C::OnCurrentStateChanged(EEJumpBoostPackState InPreviousState, EEJumpBoostPackState InCurrentState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_BoostJumpPack_C_OnCurrentStateChanged Parms{};
...
void UGA_BoostJumpPack_C::OnPawnLanded(const struct FHitResult& Hit)
{
	...
	Params::UGA_BoostJumpPack_C_OnPawnLanded Parms{};
...
void UGA_BoostJumpPack_C::OnSavedPawnChanged_(class AFortPlayerPawn* PreviousPawn, class AFortPlayerPawn* NewPawn)
{
	...
	Params::UGA_BoostJumpPack_C_OnSavedPawnChanged_ Parms{};

	*reinterpret_cast<void**>(&Parms.PreviousPawn) = reinterpret_cast<void*>(PreviousPawn);
...
void UGA_BoostJumpPack_C::PotentiallyEndHovering(bool bForceEndHovering)
{
	...
	Params::UGA_BoostJumpPack_C_PotentiallyEndHovering Parms{};
...
void UGA_BoostJumpPack_C::ProcessTriggerData(const struct FGameplayTag& TagOne)
{
	...
	Params::UGA_BoostJumpPack_C_ProcessTriggerData Parms{};
...
void UGA_BoostJumpPack_C::ResetTransitionVariables(bool bForceEndHovering)
{
	...
	Params::UGA_BoostJumpPack_C_ResetTransitionVariables Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EEJumpBoostPackState NewState (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_BoostJumpPack_C::SetCurrentBoostState(EEJumpBoostPackState NewState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_BoostJumpPack_C_SetCurrentBoostState Parms{};
...
void UGA_BoostJumpPack_C::SetJumpHeight(class AFortPlayerPawn* Pawn, class AFortPlayerPawn** Pawn_Out, struct FVector* Jump_Height)
{
	...
	Params::UGA_BoostJumpPack_C_SetJumpHeight Parms{};
...
void UGA_BoostJumpPack_C::Setup_Notify_at_Apex(bool bNotifyApex)
{
	...
	Params::UGA_BoostJumpPack_C_Setup_Notify_at_Apex Parms{};
...
void UGA_BoostJumpPack_C::SetupTransitionVariables(const struct FGameplayTag& InTag)
{
	...
	Params::UGA_BoostJumpPack_C_SetupTransitionVariables Parms{};
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// EEnum_BoostJumpStates* TargetBoostState (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_BoostJumpPack_C::TransitionFromBoost(EEnum_BoostJumpStates* TargetBoostState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_BoostJumpPack_C_TransitionFromBoost Parms{};
...
void UGA_BoostJumpPack_C::TransitionFromFalling(EEnum_BoostJumpStates* TargetBoostState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_BoostJumpPack_C_TransitionFromFalling Parms{};
...
void UGA_BoostJumpPack_C::TransitionFromHovering(EEnum_BoostJumpStates* TargetBoostState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_BoostJumpPack_C_TransitionFromHovering Parms{};
...
class AFortPlayerPawn* UGA_BoostJumpPack_C::Get_Player_Pawn(class UObject* Object) const
{
	...
	Params::UGA_BoostJumpPack_C_Get_Player_Pawn Parms{};
...
void UGA_BoostJumpPack_C::GetFuel(float* Fuel) const
{
	...
	Params::UGA_BoostJumpPack_C_GetFuel Parms{};
...
void UGA_BoostJumpPack_C::GetMaxFuel(float* MaxFuel) const
{
	...
	Params::UGA_BoostJumpPack_C_GetMaxFuel Parms{};
...
float UGA_BoostJumpPack_C::GetReserveFuel() const
{
	...
	Params::UGA_BoostJumpPack_C_GetReserveFuel Parms{};
...
bool UGA_BoostJumpPack_C::IsBoostAllowed() const
{
	...
	Params::UGA_BoostJumpPack_C_IsBoostAllowed Parms{};
...
bool UGA_BoostJumpPack_C::IsCurrentlyDead(const struct FGameplayTag& TagOne) const
{
	...
	Params::UGA_BoostJumpPack_C_IsCurrentlyDead Parms{};
...
bool UGA_BoostJumpPack_C::K2_CanActivateAbility(const struct FGameplayAbilityActorInfo& ActorInfo, const struct FGameplayAbilitySpecHandle& Handle, struct FGameplayTagContainer* RelevantTags) const
{
	...
	Params::UGA_BoostJumpPack_C_K2_CanActivateAbility Parms{};
...
bool UGA_BoostJumpPack_C::K2_ShouldAbilityRespondToEvent(const struct FGameplayAbilityActorInfo& ActorInfo, const struct FGameplayEventData& Payload) const
{
	...
	Params::UGA_BoostJumpPack_C_K2_ShouldAbilityRespondToEvent Parms{};
...
bool UGA_BoostJumpPack_C::NotInHidingSpot() const
{
	...
	Params::UGA_BoostJumpPack_C_NotInHidingSpot Parms{};
...
bool UGA_BoostJumpPack_C::Reasons_To_Reset_on_Transition(const struct FGameplayTag& tag) const
{
	...
	Params::UGA_BoostJumpPack_C_Reasons_To_Reset_on_Transition Parms{};
...
void UGA_BoostJumpPack_C::TransitionFromIdle(EEnum_BoostJumpStates* TargetBoostState) const
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_BoostJumpPack_C_TransitionFromIdle Parms{};
