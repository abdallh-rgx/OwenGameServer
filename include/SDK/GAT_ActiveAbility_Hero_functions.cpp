...
void UGAT_ActiveAbility_Hero_C::CommitAbilityWithEvent(bool* Passed)
{
	...
	Params::UGAT_ActiveAbility_Hero_C_CommitAbilityWithEvent Parms{};
...
void UGAT_ActiveAbility_Hero_C::ExecuteUbergraph_GAT_ActiveAbility_Hero(int32 EntryPoint)
{
	...
	Params::UGAT_ActiveAbility_Hero_C_ExecuteUbergraph_GAT_ActiveAbility_Hero Parms{};
...
void UGAT_ActiveAbility_Hero_C::IncrementAbilityCostAndCooldown(float Energy_Cost, bool Adjust_Cooldown, float Cooldown_Increment, TArray<struct FActiveGameplayEffectHandle>* Active_Cooldown_Modifiers_0)
{
	...
	Params::UGAT_ActiveAbility_Hero_C_IncrementAbilityCostAndCooldown Parms{};
...
void UGAT_ActiveAbility_Hero_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	Params::UGAT_ActiveAbility_Hero_C_K2_OnEndAbility Parms{};
