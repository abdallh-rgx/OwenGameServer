...
void AMASTER_TODM_C::ExecuteUbergraph_MASTER_TODM(int32 EntryPoint)
{
	...
	Params::AMASTER_TODM_C_ExecuteUbergraph_MASTER_TODM Parms{};
...
// Parameters:
// struct CoreUObject::FTransform* Transform (Parm, OutParm, IsPlainOldData, NoDestructor)

void AMASTER_TODM_C::EmptyTransform(struct CoreUObject::FTransform* Transform)
{
	static class UFunction* Func = nullptr;
	...
	Params::AMASTER_TODM_C_EmptyTransform Parms{};
...
void AMASTER_TODM_C::DisableLightAndFog(bool Enable)
{
	...
	Params::AMASTER_TODM_C_DisableLightAndFog Parms{};
