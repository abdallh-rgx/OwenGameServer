...
void UBP_TimeSynthTrackComponent_DataTracker_C::AssignDataTrackerComponent(class UFortGameplayDataTrackerComponent* DataTrackerComponent_0)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_AssignDataTrackerComponent Parms{};
...
void UBP_TimeSynthTrackComponent_DataTracker_C::ExecuteUbergraph_BP_TimeSynthTrackComponent_DataTracker(int32 EntryPoint)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_ExecuteUbergraph_BP_TimeSynthTrackComponent_DataTracker Parms{};
...
// Parameters:
// EEAthenaGamePhase GamePhase (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_TimeSynthTrackComponent_DataTracker_C::GamePhaseChanged(EEAthenaGamePhase GamePhase)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_GamePhaseChanged Parms{};
...
void UBP_TimeSynthTrackComponent_DataTracker_C::GetDataTrackerComponent(class UFortGameplayDataTrackerComponent** DataTrackerComponent_0)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_GetDataTrackerComponent Parms{};
...
void UBP_TimeSynthTrackComponent_DataTracker_C::GetIsEnabled(bool* Enabled)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_GetIsEnabled Parms{};
...
void UBP_TimeSynthTrackComponent_DataTracker_C::GetRemainingEventCooldown(float* Cooldown)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_GetRemainingEventCooldown Parms{};
...
void UBP_TimeSynthTrackComponent_DataTracker_C::OnAnyEventValueChanged(class UFortGameplayDataTrackerComponent* Data_Tracker_Component, bool Has_Event_Values)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_OnAnyEventValueChanged Parms{};

	*reinterpret_cast<void**>(&Parms.Data_Tracker_Component) = reinterpret_cast<void*>(Data_Tracker_Component);
...
void UBP_TimeSynthTrackComponent_DataTracker_C::OnDataTrackerComponentRegistered(class UFortGameplayDataTrackerComponent* Data_Tracker_Component)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_OnDataTrackerComponentRegistered Parms{};
...
void UBP_TimeSynthTrackComponent_DataTracker_C::OnDataTrackerComponentUnRegistered(class UFortGameplayDataTrackerComponent* Data_Tracker_Component)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_OnDataTrackerComponentUnRegistered Parms{};
...
void UBP_TimeSynthTrackComponent_DataTracker_C::OnReady_FFC0E068479278E143D010AF8EB81D0D(class AFortGameStateAthena* GameState, const class UFortPlaylist* Playlist, const struct FGameplayTagContainer& PlaylistContextTags)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_OnReady_FFC0E068479278E143D010AF8EB81D0D Parms{};
...
void UBP_TimeSynthTrackComponent_DataTracker_C::QueueTrackStop(bool Play_Outro)
{
	...
	Params::UBP_TimeSynthTrackComponent_DataTracker_C_QueueTrackStop Parms{};
