...
void USocialPanel_FriendLinkButton_C::ExecuteUbergraph_SocialPanel_FriendLinkButton(int32 EntryPoint)
{
	...
	Params::USocialPanel_FriendLinkButton_C_ExecuteUbergraph_SocialPanel_FriendLinkButton Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// EEFriendLinkShareButtonType Type (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void USocialPanel_FriendLinkButton_C::OnShareButtonTypeSet(EEFriendLinkShareButtonType Type)
{
	static class UFunction* Func = nullptr;
	...
	Params::USocialPanel_FriendLinkButton_C_OnShareButtonTypeSet Parms{};
