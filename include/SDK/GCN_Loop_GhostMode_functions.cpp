...
void AGCN_Loop_GhostMode_C::ExecuteUbergraph_GCN_Loop_GhostMode(int32 EntryPoint)
{
	...
	Params::AGCN_Loop_GhostMode_C_ExecuteUbergraph_GCN_Loop_GhostMode Parms{};
...
void AGCN_Loop_GhostMode_C::Highlight_Lerp(float Alpha, struct FPawnHighlight* Highlight)
{
	...
	Params::AGCN_Loop_GhostMode_C_Highlight_Lerp Parms{};
...
void AGCN_Loop_GhostMode_C::OnLoopingStart(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents)
{
	...
	Params::AGCN_Loop_GhostMode_C_OnLoopingStart Parms{};
...
void AGCN_Loop_GhostMode_C::OnRemoval(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	Params::AGCN_Loop_GhostMode_C_OnRemoval Parms{};
