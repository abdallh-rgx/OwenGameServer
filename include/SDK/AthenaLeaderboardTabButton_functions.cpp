...
void UAthenaLeaderboardTabButton_C::SetTabLabelInfo(const struct FFortTabButtonLabelInfo& TabLabelInfo)
{
	...
	Params::UAthenaLeaderboardTabButton_C_SetTabLabelInfo Parms{};
...
void UAthenaLeaderboardTabButton_C::Set_Text(const class FText& ButtonText)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAthenaLeaderboardTabButton_C_Set_Text Parms{};
...
void UAthenaLeaderboardTabButton_C::Set_Icon(const struct FSlateBrush& IconBrush)
{
	...
	Params::UAthenaLeaderboardTabButton_C_Set_Icon Parms{};
...
void UAthenaLeaderboardTabButton_C::PreConstruct(bool IsDesignTime_PreConstruct)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAthenaLeaderboardTabButton_C_PreConstruct Parms{};
...
void UAthenaLeaderboardTabButton_C::ExecuteUbergraph_AthenaLeaderboardTabButton(int32 EntryPoint)
{
	...
	Params::UAthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton Parms{};
