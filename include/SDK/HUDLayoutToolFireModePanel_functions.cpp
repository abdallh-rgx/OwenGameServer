...
// Parameters:
// bool bNewOpenState_SetOpenState (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UHUDLayoutToolFireModePanel_C::SetOpenState(bool bNewOpenState_SetOpenState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UHUDLayoutToolFireModePanel_C_SetOpenState Parms{};

	Parms.bNewOpenState_SetOpenState = bNewOpenState_SetOpenState;
...
void UHUDLayoutToolFireModePanel_C::PlayCurFocusedTileMovie(class UFireModeSelectTile_C* CurFocusedTile)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_PlayCurFocusedTileMovie Parms{};

	*reinterpret_cast<void**>(&Parms.CurFocusedTile) = reinterpret_cast<void*>(CurFocusedTile);
...
struct FEventReply UHUDLayoutToolFireModePanel_C::Func_None_0(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUDLayoutToolFireModePanel_C", "None");

	Params::UHUDLayoutToolFireModePanel_C_None Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// EEFireModeType NewFireMode (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UHUDLayoutToolFireModePanel_C::OnFire_Mode_Changed(EEFireModeType NewFireMode)
{
	static class UFunction* Func = nullptr;
	...
	Params::UHUDLayoutToolFireModePanel_C_OnFire_Mode_Changed Parms{};
...
void UHUDLayoutToolFireModePanel_C::NewTileSelected(class UFireModeSelectTile_C* Tile)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_NewTileSelected Parms{};

	*reinterpret_cast<void**>(&Parms.Tile) = reinterpret_cast<void*>(Tile);
...
void UHUDLayoutToolFireModePanel_C::InitButtonBindings(TArray<class UHUDLayoutToolFireModeButton*>& ArrayOfFireModeButtons)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_InitButtonBindings Parms{};
...
void UHUDLayoutToolFireModePanel_C::HasSelectedCustomMode(bool* Value)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_HasSelectedCustomMode Parms{};
...
void UHUDLayoutToolFireModePanel_C::HandleTileButtonFocused(class UFireModeSelectTile_C* Tile)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_HandleTileButtonFocused Parms{};
...
void UHUDLayoutToolFireModePanel_C::HandleCurSelectedTile(class UFireModeSelectTile_C* Tile)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_HandleCurSelectedTile Parms{};
...
void UHUDLayoutToolFireModePanel_C::ExecuteUbergraph_HUDLayoutToolFireModePanel(int32 EntryPoint)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_ExecuteUbergraph_HUDLayoutToolFireModePanel Parms{};
...
void UHUDLayoutToolFireModePanel_C::DeselectTile(class UFireModeSelectTile_C* Tile)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_DeselectTile Parms{};
...
void UHUDLayoutToolFireModePanel_C::BndEvt__TutorialConfirm_K2Node_ComponentBoundEvent_185_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_BndEvt__TutorialConfirm_K2Node_ComponentBoundEvent_185_CommonButtonClicked__DelegateSignature Parms{};
...
void UHUDLayoutToolFireModePanel_C::BndEvt__PresetsButton_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_BndEvt__PresetsButton_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature Parms{};
...
void UHUDLayoutToolFireModePanel_C::BndEvt__IconTextButton_K2Node_ComponentBoundEvent_84_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_BndEvt__IconTextButton_K2Node_ComponentBoundEvent_84_CommonButtonClicked__DelegateSignature Parms{};
...
void UHUDLayoutToolFireModePanel_C::BndEvt__CustomButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	...
	Params::UHUDLayoutToolFireModePanel_C_BndEvt__CustomButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature Parms{};
...
void UHUDLayoutToolFireModePanel_C::IsInCustomMode(bool* IsCustom) const
{
	...
	Params::UHUDLayoutToolFireModePanel_C_IsInCustomMode Parms{};
