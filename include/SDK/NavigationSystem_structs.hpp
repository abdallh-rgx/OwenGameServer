...
// NumValues: 0x0005
enum class EERuntimeGenerationType : uint8
{
	Static = 0,
...
// NumValues: 0x0004
enum class EENavCostDisplay : uint8
{
	TotalCost = 0,
	HeuristicOnly = 1,
	RealCostOnly = 2,
...
// NumValues: 0x0004
enum class EENavSystemOverridePolicy : uint8
{
	Override = 0,
	Append = 1,
	Skip = 2,
...
// NumValues: 0x0004
enum class EERecastPartitioning : uint8
{
	Monotone = 0,
	Watershed = 1,
	ChunkyMonotone = 2,
...
public:
	...
	EERecastPartitioning RegionPartitioning; // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EERecastPartitioning LayerPartitioning; // 0x0031(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
