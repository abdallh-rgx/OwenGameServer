...
// NumValues: 0x0003
enum class EEBuoyancyEvent : uint8
{
	EnteredWaterBody = 0,
	ExitedWaterBody = 1,
...
// NumValues: 0x0004
enum class EEWaveSpectrumType : uint8
{
	Phillips = 0,
	PiersonMoskowitz = 1,
	JONSWAP = 2,
...
// NumValues: 0x0004
enum class EEWaterBrushBlendType : uint8
{
	AlphaBlend = 0,
	Min = 1,
	Max = 2,
...
// NumValues: 0x0006
enum class EEWaterBodyType : uint8
{
	River = 0,
	Lake = 1,
	Ocean = 2,
...
// NumValues: 0x0003
enum class EEWaterBrushFalloffMode : uint8
{
	Angle = 0,
	Width = 1,
...
public:
	...
	EEWaterBrushFalloffMode FalloffMode; // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	EEWaterBrushBlendType BlendMode; // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
