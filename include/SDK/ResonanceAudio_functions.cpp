...
void UResonanceAudioSpatializationSourceSettings::SetSoundSourceDirectivity(float InPattern, float InSharpness)
{
	...
	Params::UResonanceAudioSpatializationSourceSettings_SetSoundSourceDirectivity Parms{};
...
void UResonanceAudioSpatializationSourceSettings::SetSoundSourceSpread(float InSpread)
{
	...
	Params::UResonanceAudioSpatializationSourceSettings_SetSoundSourceSpread Parms{};
...
void UResonanceAudioReverbPluginPreset::SetEnableRoomEffects(bool bInEnableRoomEffects)
{
	...
	Params::UResonanceAudioReverbPluginPreset_SetEnableRoomEffects Parms{};
...
void UResonanceAudioReverbPluginPreset::SetReflectionScalar(float InReflectionScalar)
{
	...
	Params::UResonanceAudioReverbPluginPreset_SetReflectionScalar Parms{};
...
void UResonanceAudioReverbPluginPreset::SetReverbBrightness(float InReverbBrightness)
{
	...
	Params::UResonanceAudioReverbPluginPreset_SetReverbBrightness Parms{};
...
void UResonanceAudioReverbPluginPreset::SetReverbGain(float InReverbGain)
{
	...
	Params::UResonanceAudioReverbPluginPreset_SetReverbGain Parms{};
...
void UResonanceAudioReverbPluginPreset::SetReverbTimeModifier(float InReverbTimeModifier)
{
	...
	Params::UResonanceAudioReverbPluginPreset_SetReverbTimeModifier Parms{};
...
void UResonanceAudioReverbPluginPreset::SetRoomDimensions(const struct FVector& InDimensions)
{
	...
	Params::UResonanceAudioReverbPluginPreset_SetRoomDimensions Parms{};
...
// Parameters:
// const TArray<EERaMaterialName>& InMaterials (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void UResonanceAudioReverbPluginPreset::SetRoomMaterials(const TArray<EERaMaterialName>& InMaterials)
{
	static class UFunction* Func = nullptr;
	...
	Params::UResonanceAudioReverbPluginPreset_SetRoomMaterials Parms{};
...
void UResonanceAudioReverbPluginPreset::SetRoomPosition(const struct FVector& InPosition)
{
	...
	Params::UResonanceAudioReverbPluginPreset_SetRoomPosition Parms{};
...
void UResonanceAudioReverbPluginPreset::SetRoomRotation(const struct FQuat& InRotation)
{
	...
	Params::UResonanceAudioReverbPluginPreset_SetRoomRotation Parms{};
...
class UResonanceAudioReverbPluginPreset* UResonanceAudioBlueprintFunctionLibrary::GetGlobalReverbPreset()
{
	...
	Params::UResonanceAudioBlueprintFunctionLibrary_GetGlobalReverbPreset Parms{};
...
void UResonanceAudioBlueprintFunctionLibrary::SetGlobalReverbPreset(class UResonanceAudioReverbPluginPreset* InPreset)
{
	...
	Params::UResonanceAudioBlueprintFunctionLibrary_SetGlobalReverbPreset Parms{};

	*reinterpret_cast<void**>(&Parms.InPreset) = reinterpret_cast<void*>(InPreset);
