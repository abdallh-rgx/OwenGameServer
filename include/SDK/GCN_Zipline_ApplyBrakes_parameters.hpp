...
struct UGCN_Zipline_ApplyBrakes_C_OnBurstGeneric final
{
public:
	UGCN_Zipline_ApplyBrakes_C_OnBurstGeneric() {}
...
#endif
DUMPER7_ASSERTS_UGCN_Zipline_ApplyBrakes_C_OnBurstGeneric;
#if defined(__clang__) || defined(__GNUC__)
