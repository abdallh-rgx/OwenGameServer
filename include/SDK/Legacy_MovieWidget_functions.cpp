...
void ULegacy_MovieWidget_C::ExecuteUbergraph_Legacy_MovieWidget(int32 EntryPoint)
{
	...
	Params::ULegacy_MovieWidget_C_ExecuteUbergraph_Legacy_MovieWidget Parms{};
...
void ULegacy_MovieWidget_C::Init(class UMediaPlayer* InMediaPlayer, class UMediaSource* InMediaSource, class UObject* InMediaSoundWave, int32 AudioTrack)
{
	...
	Params::ULegacy_MovieWidget_C_Init Parms{};

	*reinterpret_cast<void**>(&Parms.InMediaPlayer) = reinterpret_cast<void*>(InMediaPlayer);
	*reinterpret_cast<void**>(&Parms.InMediaSource) = reinterpret_cast<void*>(InMediaSource);
	*reinterpret_cast<void**>(&Parms.InMediaSoundWave) = reinterpret_cast<void*>(InMediaSoundWave);
...
void ULegacy_MovieWidget_C::MediaDimensionsUpdated(float NewWidth, float NewHeight)
{
	...
	Params::ULegacy_MovieWidget_C_MediaDimensionsUpdated Parms{};
...
void ULegacy_MovieWidget_C::Play(bool ShouldRewind)
{
	...
	Params::ULegacy_MovieWidget_C_Play Parms{};
