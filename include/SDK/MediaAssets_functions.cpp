...
void UMediaTexture::SetMediaPlayer(class UMediaPlayer* NewMediaPlayer)
{
	...
	*reinterpret_cast<void**>(&Parms.NewMediaPlayer) = reinterpret_cast<void*>(NewMediaPlayer);
...
// EEMediaSoundComponentFFTSize InFFTSize (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMediaSoundComponent::SetSpectralAnalysisSettings(const TArray<float>& InFrequenciesToAnalyze, EEMediaSoundComponentFFTSize InFFTSize)
{
	static class UFunction* Func = nullptr;
...
bool UMediaPlaylist::Add(class UMediaSource* MediaSource)
{
	...
	*reinterpret_cast<void**>(&Parms.MediaSource) = reinterpret_cast<void*>(MediaSource);
...
bool UMediaPlaylist::Replace(int32 Index_0, class UMediaSource* Replacement)
{
	...
	Parms.Index_0 = Index_0;
	*reinterpret_cast<void**>(&Parms.Replacement) = reinterpret_cast<void*>(Replacement);
...
bool UMediaPlayer::OpenPlaylist(class UMediaPlaylist* InPlaylist)
{
	...
	*reinterpret_cast<void**>(&Parms.InPlaylist) = reinterpret_cast<void*>(InPlaylist);
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// EEMediaPlayerTrack TrackType (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32 TrackIndex (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UMediaPlayer::SelectTrack(EEMediaPlayerTrack TrackType, int32 TrackIndex)
{
	static class UFunction* Func = nullptr;
...
void UMediaPlayer::SetMediaOptions(const class UMediaSource* Options)
{
	...
	*reinterpret_cast<const void**>(&Parms.Options) = reinterpret_cast<const void*>(Options);
...
bool UMediaPlayer::SetTrackFormat(EEMediaPlayerTrack TrackType, int32 TrackIndex, int32 FormatIndex)
{
	static class UFunction* Func = nullptr;
...
int32 UMediaPlayer::GetNumTrackFormats(EEMediaPlayerTrack TrackType, int32 TrackIndex) const
{
	static class UFunction* Func = nullptr;
...
int32 UMediaPlayer::GetNumTracks(EEMediaPlayerTrack TrackType) const
{
	static class UFunction* Func = nullptr;
...
int32 UMediaPlayer::GetSelectedTrack(EEMediaPlayerTrack TrackType) const
{
	static class UFunction* Func = nullptr;
...
class FText UMediaPlayer::GetTrackDisplayName(EEMediaPlayerTrack TrackType, int32 TrackIndex) const
{
	static class UFunction* Func = nullptr;
...
int32 UMediaPlayer::GetTrackFormat(EEMediaPlayerTrack TrackType, int32 TrackIndex) const
{
	static class UFunction* Func = nullptr;
...
class FString UMediaPlayer::GetTrackLanguage(EEMediaPlayerTrack TrackType, int32 TrackIndex) const
{
	static class UFunction* Func = nullptr;
