...
void UB_MusicEventDebugWidget_C::ExecuteUbergraph_B_MusicEventDebugWidget(int32 EntryPoint)
{
	...
	Params::UB_MusicEventDebugWidget_C_ExecuteUbergraph_B_MusicEventDebugWidget Parms{};
...
void UB_MusicEventDebugWidget_C::SetEventInstances(const TArray<class UMusicEventInstance*>& Instances_0)
{
	...
	Params::UB_MusicEventDebugWidget_C_SetEventInstances Parms{};
...
void UB_MusicEventDebugWidget_C::SetMusicEventAssetFilter(const class FString& Filter)
{
	...
	Params::UB_MusicEventDebugWidget_C_SetMusicEventAssetFilter Parms{};
...
void UB_MusicEventDebugWidget_C::SetMusicEventFontSize(int32 Size)
{
	...
	Params::UB_MusicEventDebugWidget_C_SetMusicEventFontSize Parms{};
...
void UB_MusicEventDebugWidget_C::SetMusicEventPos(float X, float Y)
{
	static class UFunction* Func = nullptr;
	...
	Params::UB_MusicEventDebugWidget_C_SetMusicEventPos Parms{};
