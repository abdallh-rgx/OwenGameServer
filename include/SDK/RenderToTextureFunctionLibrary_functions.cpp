...
// Parameters:
// EEIntTypes Type (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void URenderToTextureFunctionLibrary_C::Array_to_HLSL_Int_Array(EEIntTypes Type, class FString& Variable_Name, TArray<int32>& Int, TArray<struct FVector2D>& int2, TArray<struct FVector>& int3, TArray<struct FLinearColor>& int4, class UObject* __WorldContext, class FString* String)
{
	...
	Params::URenderToTextureFunctionLibrary_C_Array_to_HLSL_Int_Array Parms{};
...
void URenderToTextureFunctionLibrary_C::Set_Canvas_Material_Scale_and_Position(const struct FVector2D& Size, const struct FVector2D& Position, float Scale, class UObject* __WorldContext, struct FVector2D* Screen_Position, struct FVector2D* Screen_Size)
{
	...
	Params::URenderToTextureFunctionLibrary_C_Set_Canvas_Material_Scale_and_Position Parms{};
