...
void UFortConversationScreen::OnConversationOptionUnavailable(class UFortRadialSlot* SelectedEntry)
{
	...
	Params::UFortConversationScreen_OnConversationOptionUnavailable Parms{};

	*reinterpret_cast<void**>(&Parms.SelectedEntry) = reinterpret_cast<void*>(SelectedEntry);
...
void UFortConversationScreen::OnItemSelected(int32 OriginalIndex)
{
	...
	Params::UFortConversationScreen_OnItemSelected Parms{};
...
void UFortConversationScreen::OnSelectedItemAvailabilityChanged(bool bIsAvailable)
{
	...
	Params::UFortConversationScreen_OnSelectedItemAvailabilityChanged Parms{};
...
bool UFortConversationScreen::ShouldBlockOptionIntroAnim() const
{
	...
	Params::UFortConversationScreen_ShouldBlockOptionIntroAnim Parms{};
...
void UFortConversationOptionBrief::ConfigureBP(const struct FConversationContext& ClientContext, const struct FClientConversationOptionEntry& OptionEntry, const int32 SelectedIndex)
{
	...
	Params::UFortConversationOptionBrief_ConfigureBP Parms{};
...
void UFortItemTransactionBrief::OnTransactionInfoReceived(class UFortItem* Item)
{
	...
	Params::UFortItemTransactionBrief_OnTransactionInfoReceived Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// EEFortWeaponUpgradeInteractionResult CannotUpgradeCause (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortUpgradeBrief::OnUnableToUpgrade(EEFortWeaponUpgradeInteractionResult CannotUpgradeCause)
{
	static class UFunction* Func = nullptr;
	...
	Params::UFortUpgradeBrief_OnUnableToUpgrade Parms{};
...
void UFortUpgradeBrief::OnUpgradeInfoReceived(class UFortItem* CurrentWeapon)
{
	...
	Params::UFortUpgradeBrief_OnUpgradeInfoReceived Parms{};

	*reinterpret_cast<void**>(&Parms.CurrentWeapon) = reinterpret_cast<void*>(CurrentWeapon);
...
void UFortMultiItemFundBrief::UpdateSelectedVisuals(int32 SelectedIndex)
{
	...
	Params::UFortMultiItemFundBrief_UpdateSelectedVisuals Parms{};
...
const class FText UFortItemFundBrief::GetDataForKey(const class FString& Key, const bool bUseIndexAdjustment)
{
	...
	Params::UFortItemFundBrief_GetDataForKey Parms{};
...
void UFortItemFundBrief::InitializeFromContext(const struct FConversationContext& ConversationContext)
{
	...
	Params::UFortItemFundBrief_InitializeFromContext Parms{};
...
void UFortItemFundBrief::OnProgressUpdated(const float CurrentFundingFraction)
{
	...
	Params::UFortItemFundBrief_OnProgressUpdated Parms{};
...
void UFortDuelBrief::DisplayLootItems(const TArray<class UFortItem*>& Items)
{
	...
	Params::UFortDuelBrief_DisplayLootItems Parms{};
...
void UFortDataDrivenServiceBrief::OnTransactionInfoReceived(class UFortItem* Item)
{
	...
	Params::UFortDataDrivenServiceBrief_OnTransactionInfoReceived Parms{};
...
void UFortDataDrivenServiceBrief::OnUnableToPurchase(const class FText& Reason)
{
	...
	Params::UFortDataDrivenServiceBrief_OnUnableToPurchase Parms{};
...
void UFortConversationMessageWidget::OnMainMessageSet(const class FText& NPCName, const class FText& MessageBody)
{
	...
	Params::UFortConversationMessageWidget_OnMainMessageSet Parms{};
...
void UFortConversationMessageWidget::OnPreviewMessageSet(const class FText& PreviewText)
{
	...
	Params::UFortConversationMessageWidget_OnPreviewMessageSet Parms{};
...
void UFortConversationMessageWidget::SetPreviewMessage(const class FText& MessageToSet)
{
	...
	Params::UFortConversationMessageWidget_SetPreviewMessage Parms{};
...
void UFortConversationMarker::OnCanInteract(bool bCanInteract)
{
	...
	Params::UFortConversationMarker_OnCanInteract Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// EEInteractionRange TargetInteractionRange (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UFortConversationMarker::OnConversationActorProximityChanged(EEInteractionRange TargetInteractionRange, class UFortNonPlayerConversationParticipantComponent* ConversationComponent)
{
	static class UFunction* Func = nullptr;
	...
	Params::UFortConversationMarker_OnConversationActorProximityChanged Parms{};

	Parms.TargetInteractionRange = TargetInteractionRange;
	*reinterpret_cast<void**>(&Parms.ConversationComponent) = reinterpret_cast<void*>(ConversationComponent);
...
void UFortConversationMarker::OnInteractionRangeChanged(EEInteractionRange TargetInteractionRange)
{
	static class UFunction* Func = nullptr;
	...
	Params::UFortConversationMarker_OnInteractionRangeChanged Parms{};
...
void UFortConversationMarker::OnMessageShownOverActor(class AActor* OverActor)
{
	...
	Params::UFortConversationMarker_OnMessageShownOverActor Parms{};

	*reinterpret_cast<void**>(&Parms.OverActor) = reinterpret_cast<void*>(OverActor);
...
void UFortConversationMarker::OnSetIndicatedActor(class AActor* NewIndicatorActor)
{
	...
	Params::UFortConversationMarker_OnSetIndicatedActor Parms{};

	*reinterpret_cast<void**>(&Parms.NewIndicatorActor) = reinterpret_cast<void*>(NewIndicatorActor);
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// EECannotBuyReason CannotBuyReason (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortBuyBrief::OnDisplayUnavailability(EECannotBuyReason CannotBuyReason)
{
	static class UFunction* Func = nullptr;
	...
	Params::UFortBuyBrief_OnDisplayUnavailability Parms{};
...
void UFortBuyBrief::OnPurchaseDataReceived(int32 StackSize, int32 RemainingForSale)
{
	...
	Params::UFortBuyBrief_OnPurchaseDataReceived Parms{};
...
void UFortTransactionStrip::HandleOnItemCountChanged(TScriptInterface<class IFortInventoryOwnerInterface> InventoryOwner, class UFortItemDefinition* Definition, int32 Delta)
{
	...
	Params::UFortTransactionStrip_HandleOnItemCountChanged Parms{};

	Parms.InventoryOwner = InventoryOwner;
	*reinterpret_cast<void**>(&Parms.Definition) = reinterpret_cast<void*>(Definition);
	Parms.Delta = Delta;
...
void UFortTransactionStrip::OnSetTransactionCostVisibility(const bool bVisible)
{
	...
	Params::UFortTransactionStrip_OnSetTransactionCostVisibility Parms{};
...
void UFortTransactionStrip::OnTransactionInfoReceived(const struct FFortServiceTransactionInfo& TransactionInfo)
{
	...
	Params::UFortTransactionStrip_OnTransactionInfoReceived Parms{};
...
void UFortBasicItemBrief::OnAbleToUse(const bool bShowWarningMessage)
{
	...
	Params::UFortBasicItemBrief_OnAbleToUse Parms{};
...
void UFortBasicItemBrief::OnItemInfoReceived(class UFortItem* Item, int32 StackSize)
{
	...
	Params::UFortBasicItemBrief_OnItemInfoReceived Parms{};
...
void UFortBasicItemBrief::OnUnableToUse(const class FText& Reason)
{
	...
	Params::UFortBasicItemBrief_OnUnableToUse Parms{};
...
void UFortBasicItemBrief::OnUpdateDescriptionText(const class FText& DescriptionText)
{
	...
	Params::UFortBasicItemBrief_OnUpdateDescriptionText Parms{};
...
class UPanelSlot* UFortConversationOptionsPanel::AddChildToDynamicPanel(class UWidget* Content)
{
	...
	Params::UFortConversationOptionsPanel_AddChildToDynamicPanel Parms{};
...
void UFortBasicBrief::OnChoiceTextReceived(const class FText& Text)
{
	...
	Params::UFortBasicBrief_OnChoiceTextReceived Parms{};
...
void UFortConversationOption::OnSetupFromDisplayAsset(class UObject* DisplayAsset)
{
	...
	Params::UFortConversationOption_OnSetupFromDisplayAsset Parms{};

	*reinterpret_cast<void**>(&Parms.DisplayAsset) = reinterpret_cast<void*>(DisplayAsset);
...
void UFortConversationOption::OnSetupFromItemDef(class UFortItem* Item)
{
	...
	Params::UFortConversationOption_OnSetupFromItemDef Parms{};
...
void UFortConversationOption::OnSetupPivotFromRadialInformation(int32 NumElements, int32 ItemIndex)
{
	...
	Params::UFortConversationOption_OnSetupPivotFromRadialInformation Parms{};
...
bool UFortConversationOption::IsAvailable() const
{
	...
	Params::UFortConversationOption_IsAvailable Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// EEPreventUseStormCircleServiceReason Reason (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortShowFutureStormCircleBrief::OnUnableToPurchase(EEPreventUseStormCircleServiceReason Reason)
{
	static class UFunction* Func = nullptr;
	...
	Params::UFortShowFutureStormCircleBrief_OnUnableToPurchase Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// EEPreventAbilityUseReason Reason (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortApplyAbilityBrief::OnUnableToPurchase(EEPreventAbilityUseReason Reason)
{
	static class UFunction* Func = nullptr;
	...
	Params::UFortApplyAbilityBrief_OnUnableToPurchase Parms{};
...
void UFortQuestBrief::OnQuestExpirationTimeSet(const bool bDisplayExpirationTime)
{
	...
	Params::UFortQuestBrief_OnQuestExpirationTimeSet Parms{};
...
void UFortQuestBrief::OnQuestInformationRecieved(const class FText& Objective, const struct FFortRarityItemData& RarityData, const struct FGameplayTag& CategoryTag, int32 XPReward, int32 MoneyReward)
{
	...
	Params::UFortQuestBrief_OnQuestInformationRecieved Parms{};
...
void UFortNPCTextDisplay::OnItemNameUpdated(const class FString& ItemName)
{
	...
	Params::UFortNPCTextDisplay_OnItemNameUpdated Parms{};
