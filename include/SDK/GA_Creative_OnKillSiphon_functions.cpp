...
void UGA_Creative_OnKillSiphon_C::AddShields(bool bShouldConvertExcessHealthToShields_0, float ShieldToAdd, bool* bAddedShields, float* ShieldAdded)
{
	...
	Params::UGA_Creative_OnKillSiphon_C_AddShields Parms{};
...
// Parameters:
// EEFortResourceType ResourceGrantType (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool* bSuccess (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32* ResourceToGive (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EEFortResourceType* ResourceType (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_Creative_OnKillSiphon_C::CalculateResources(EEFortResourceType ResourceGrantType, bool* bSuccess, int32* ResourceToGive, EEFortResourceType* ResourceType)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_Creative_OnKillSiphon_C_CalculateResources Parms{};
...
void UGA_Creative_OnKillSiphon_C::DetermineHealthDelta(float HealingAmount, float* MaxHealth, float* CurrentHealth, float* HealthDelta, float* ExcessHealh)
{
	...
	Params::UGA_Creative_OnKillSiphon_C_DetermineHealthDelta Parms{};
...
void UGA_Creative_OnKillSiphon_C::ExecuteUbergraph_GA_Creative_OnKillSiphon(int32 EntryPoint)
{
	...
	Params::UGA_Creative_OnKillSiphon_C_ExecuteUbergraph_GA_Creative_OnKillSiphon Parms{};
...
// EEFortResourceType GiveType (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool* Success (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_Creative_OnKillSiphon_C::GiveResourcesToPlayer(bool bShouldGrant, int32 GiveAmount, EEFortResourceType GiveType, bool* Success)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGA_Creative_OnKillSiphon_C_GiveResourcesToPlayer Parms{};
...
void UGA_Creative_OnKillSiphon_C::K2_ActivateAbilityFromEvent(const struct FGameplayEventData& EventData)
{
	...
	Params::UGA_Creative_OnKillSiphon_C_K2_ActivateAbilityFromEvent Parms{};
...
void UGA_Creative_OnKillSiphon_C::RestoreHealth(bool* Success, float* InitialHealAmount, float* ActualAppliedHeal, float* ExcessHealing)
{
	...
	Params::UGA_Creative_OnKillSiphon_C_RestoreHealth Parms{};
...
void UGA_Creative_OnKillSiphon_C::SetupRestoreModes(bool* ShouldContinue)
{
	...
	Params::UGA_Creative_OnKillSiphon_C_SetupRestoreModes Parms{};
...
bool UGA_Creative_OnKillSiphon_C::K2_ShouldAbilityRespondToEvent(const struct FGameplayAbilityActorInfo& ActorInfo, const struct FGameplayEventData& Payload) const
{
	...
	Params::UGA_Creative_OnKillSiphon_C_K2_ShouldAbilityRespondToEvent Parms{};
