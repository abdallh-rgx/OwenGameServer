...
void UGA_Athena_Lockout_C::ExecuteUbergraph_GA_Athena_Lockout(int32 EntryPoint)
{
	...
	Params::UGA_Athena_Lockout_C_ExecuteUbergraph_GA_Athena_Lockout Parms{};
...
void UGA_Athena_Lockout_C::FailedToActivatePassiveAbility()
{
	static class UFunction* Func = nullptr;
...
void UGA_Athena_Lockout_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	Params::UGA_Athena_Lockout_C_K2_OnEndAbility Parms{};
