...
void USmartObjectSubsystem::AddTagToInstance(const struct FSmartObjectHandle& Handle, const struct FGameplayTag& tag)
{
	...
	Params::USmartObjectSubsystem_AddTagToInstance Parms{};
...
struct FSmartObjectClaimHandle USmartObjectSubsystem::Claim(const struct FSmartObjectRequestResult& RequestResult)
{
	...
	Params::USmartObjectSubsystem_Claim Parms{};
...
const class USmartObjectBehaviorDefinition* USmartObjectSubsystem::GetBehaviorDefinition(const struct FSmartObjectClaimHandle& ClaimHandle, const TSubclassOf<class USmartObjectBehaviorDefinition>& DefinitionClass)
{
	...
	Params::USmartObjectSubsystem_GetBehaviorDefinition Parms{};
...
bool USmartObjectSubsystem::Release(const struct FSmartObjectClaimHandle& ClaimHandle)
{
	...
	Params::USmartObjectSubsystem_Release Parms{};
...
void USmartObjectSubsystem::RemoveTagFromInstance(const struct FSmartObjectHandle& Handle, const struct FGameplayTag& tag)
{
	...
	Params::USmartObjectSubsystem_RemoveTagFromInstance Parms{};
...
const class USmartObjectBehaviorDefinition* USmartObjectSubsystem::Use(const struct FSmartObjectClaimHandle& ClaimHandle, const TSubclassOf<class USmartObjectBehaviorDefinition>& DefinitionClass)
{
	...
	Params::USmartObjectSubsystem_Use Parms{};
...
struct FSmartObjectRequestResult USmartObjectSubsystem::FindSmartObject(const struct FSmartObjectRequest& Request) const
{
	...
	Params::USmartObjectSubsystem_FindSmartObject Parms{};
...
bool USmartObjectSubsystem::FindSmartObjects(const struct FSmartObjectRequest& Request, TArray<struct FSmartObjectRequestResult>* OutResults) const
{
	...
	Params::USmartObjectSubsystem_FindSmartObjects Parms{};
...
const struct FGameplayTagContainer USmartObjectSubsystem::GetInstanceTags(const struct FSmartObjectHandle& Handle) const
{
	...
	Params::USmartObjectSubsystem_GetInstanceTags Parms{};
...
bool USmartObjectSubsystem::GetSlotLocation(const struct FSmartObjectClaimHandle& ClaimHandle, struct FVector* OutSlotLocation) const
{
	...
	Params::USmartObjectSubsystem_GetSlotLocation Parms{};
...
// Parameters:
// const struct FSmartObjectClaimHandle& ClaimHandle (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// struct CoreUObject::FTransform* OutSlotTransform (Parm, OutParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// bool ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool USmartObjectSubsystem::GetSlotTransform(const struct FSmartObjectClaimHandle& ClaimHandle, struct CoreUObject::FTransform* OutSlotTransform) const
{
	static class UFunction* Func = nullptr;
	...
	Params::USmartObjectSubsystem_GetSlotTransform Parms{};
...
class USmartObjectComponent* USmartObjectSubsystem::GetSmartObjectComponent(const struct FSmartObjectClaimHandle& ClaimHandle) const
{
	...
	Params::USmartObjectSubsystem_GetSmartObjectComponent Parms{};
...
struct FSmartObjectClaimHandle USmartObjectBlueprintFunctionLibrary::GetValueAsSOClaimHandle(class UBlackboardComponent* BlackboardComponent, const class FName& KeyName)
{
	...
	Params::USmartObjectBlueprintFunctionLibrary_GetValueAsSOClaimHandle Parms{};

	*reinterpret_cast<void**>(&Parms.BlackboardComponent) = reinterpret_cast<void*>(BlackboardComponent);
...
bool USmartObjectBlueprintFunctionLibrary::IsValidSmartObjectClaimHandle(const struct FSmartObjectClaimHandle& Handle)
{
	...
	Params::USmartObjectBlueprintFunctionLibrary_IsValidSmartObjectClaimHandle Parms{};
...
bool USmartObjectBlueprintFunctionLibrary::K2_AddLooseGameplayTags(class AActor* Actor, const struct FGameplayTagContainer& GameplayTags)
{
	...
	Params::USmartObjectBlueprintFunctionLibrary_K2_AddLooseGameplayTags Parms{};
...
bool USmartObjectBlueprintFunctionLibrary::K2_RemoveLooseGameplayTags(class AActor* Actor, const struct FGameplayTagContainer& GameplayTags)
{
	...
	Params::USmartObjectBlueprintFunctionLibrary_K2_RemoveLooseGameplayTags Parms{};
...
bool USmartObjectBlueprintFunctionLibrary::K2_SetSmartObjectEnabled(class AActor* SmartObject, const bool bEnabled)
{
	...
	Params::USmartObjectBlueprintFunctionLibrary_K2_SetSmartObjectEnabled Parms{};

	*reinterpret_cast<void**>(&Parms.SmartObject) = reinterpret_cast<void*>(SmartObject);
...
bool USmartObjectBlueprintFunctionLibrary::K2_UseSmartObject(class AActor* Avatar, class AActor* SmartObject)
{
	...
	Params::USmartObjectBlueprintFunctionLibrary_K2_UseSmartObject Parms{};

	*reinterpret_cast<void**>(&Parms.Avatar) = reinterpret_cast<void*>(Avatar);
	*reinterpret_cast<void**>(&Parms.SmartObject) = reinterpret_cast<void*>(SmartObject);
...
void USmartObjectBlueprintFunctionLibrary::SetValueAsSOClaimHandle(class UBlackboardComponent* BlackboardComponent, const class FName& KeyName, const struct FSmartObjectClaimHandle& Value)
{
	...
	Params::USmartObjectBlueprintFunctionLibrary_SetValueAsSOClaimHandle Parms{};
...
class UAITask_UseSmartObject* UAITask_UseSmartObject::UseClaimedSmartObject(class AAIController* Controller, const struct FSmartObjectClaimHandle& ClaimHandle, bool bLockAILogic)
{
	...
	Params::UAITask_UseSmartObject_UseClaimedSmartObject Parms{};
...
class UAITask_UseSmartObject* UAITask_UseSmartObject::UseSmartObject(class AAIController* Controller, class AActor* SmartObjectActor, class USmartObjectComponent* SmartObjectComponent, bool bLockAILogic)
{
	...
	Params::UAITask_UseSmartObject_UseSmartObject Parms{};

	*reinterpret_cast<void**>(&Parms.Controller) = reinterpret_cast<void*>(Controller);
	*reinterpret_cast<void**>(&Parms.SmartObjectActor) = reinterpret_cast<void*>(SmartObjectActor);
	*reinterpret_cast<void**>(&Parms.SmartObjectComponent) = reinterpret_cast<void*>(SmartObjectComponent);
	Parms.bLockAILogic = bLockAILogic;
