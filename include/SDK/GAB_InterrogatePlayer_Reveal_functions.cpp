...
void UGAB_InterrogatePlayer_Reveal_C::Cancelled_23F3C2DB411862D627ACFCA8233F7B33(const struct FGameplayAbilityTargetDataHandle& TargetData, const struct FGameplayTag& ApplicationTag)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_Cancelled_23F3C2DB411862D627ACFCA8233F7B33 Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::Cancelled_3C2C8C224B62B00BDEEAF5AF38A401C1(const struct FGameplayAbilityTargetDataHandle& TargetData, const struct FGameplayTag& ApplicationTag)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_Cancelled_3C2C8C224B62B00BDEEAF5AF38A401C1 Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::Completed_23F3C2DB411862D627ACFCA8233F7B33(const struct FGameplayAbilityTargetDataHandle& TargetData, const struct FGameplayTag& ApplicationTag)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_Completed_23F3C2DB411862D627ACFCA8233F7B33 Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::Completed_3C2C8C224B62B00BDEEAF5AF38A401C1(const struct FGameplayAbilityTargetDataHandle& TargetData, const struct FGameplayTag& ApplicationTag)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_Completed_3C2C8C224B62B00BDEEAF5AF38A401C1 Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::ExecuteUbergraph_GAB_InterrogatePlayer_Reveal(int32 EntryPoint)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_ExecuteUbergraph_GAB_InterrogatePlayer_Reveal Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::GAB_InterrogatePlayer_Reveal_AutoGenFunc(class AActor* IndicatedActor)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_GAB_InterrogatePlayer_Reveal_AutoGenFunc Parms{};

	*reinterpret_cast<void**>(&Parms.IndicatedActor) = reinterpret_cast<void*>(IndicatedActor);
...
TArray<class AFortPlayerStateAthena*> UGAB_InterrogatePlayer_Reveal_C::GetTeamMembers(class APawn* Target, bool bIncludeSelf)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_GetTeamMembers Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::K2_ActivateAbilityFromEvent(const struct FGameplayEventData& EventData)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_K2_ActivateAbilityFromEvent Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_K2_OnEndAbility Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::None(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GAB_InterrogatePlayer_Reveal_C", "None");

	Params::UGAB_InterrogatePlayer_Reveal_C_None Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::ToggleReticleVisibility(bool Hide)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_ToggleReticleVisibility Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::Triggered_23F3C2DB411862D627ACFCA8233F7B33(const struct FGameplayAbilityTargetDataHandle& TargetData, const struct FGameplayTag& ApplicationTag)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_Triggered_23F3C2DB411862D627ACFCA8233F7B33 Parms{};
...
void UGAB_InterrogatePlayer_Reveal_C::Triggered_3C2C8C224B62B00BDEEAF5AF38A401C1(const struct FGameplayAbilityTargetDataHandle& TargetData, const struct FGameplayTag& ApplicationTag)
{
	...
	Params::UGAB_InterrogatePlayer_Reveal_C_Triggered_3C2C8C224B62B00BDEEAF5AF38A401C1 Parms{};
