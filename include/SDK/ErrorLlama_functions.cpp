...
void UErrorLlama_C::ExecuteUbergraph_ErrorLlama(int32 EntryPoint)
{
	...
	Params::UErrorLlama_C_ExecuteUbergraph_ErrorLlama Parms{};
...
void UErrorLlama_C::HandleInputTypeChanged(EECommonInputType NewInputType)
{
	static class UFunction* Func = nullptr;
	...
	Params::UErrorLlama_C_HandleInputTypeChanged Parms{};
...
void UErrorLlama_C::HandleNormalizedInputDirection(const struct FVector2D& TwoDInputVec)
{
	...
	Params::UErrorLlama_C_HandleNormalizedInputDirection Parms{};
...
void UErrorLlama_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	...
	Params::UErrorLlama_C_Tick Parms{};
