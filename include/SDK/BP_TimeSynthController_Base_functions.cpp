...
void ABP_TimeSynthController_Base_C::CalculateMaxClipDuration(class UBP_TimeSynthTrackComponent_C* Track, int32* Duration)
{
	...
	Params::ABP_TimeSynthController_Base_C_CalculateMaxClipDuration Parms{};
...
void ABP_TimeSynthController_Base_C::ChangeTrack(class UBP_TimeSynthTrackComponent_C* New_Track)
{
	...
	Params::ABP_TimeSynthController_Base_C_ChangeTrack Parms{};

	*reinterpret_cast<void**>(&Parms.New_Track) = reinterpret_cast<void*>(New_Track);
...
void ABP_TimeSynthController_Base_C::ExecuteUbergraph_BP_TimeSynthController_Base(int32 EntryPoint)
{
	...
	Params::ABP_TimeSynthController_Base_C_ExecuteUbergraph_BP_TimeSynthController_Base Parms{};
...
void ABP_TimeSynthController_Base_C::FlushExtraClips(bool Exclude_Current)
{
	...
	Params::ABP_TimeSynthController_Base_C_FlushExtraClips Parms{};
...
void ABP_TimeSynthController_Base_C::GetIsPlaying(bool* IsPlaying_0)
{
	...
	Params::ABP_TimeSynthController_Base_C_GetIsPlaying Parms{};
...
void ABP_TimeSynthController_Base_C::GetTimeSynthComponent(class UTimeSynthComponent** TimeSynth_0)
{
	...
	Params::ABP_TimeSynthController_Base_C_GetTimeSynthComponent Parms{};
...
void ABP_TimeSynthController_Base_C::OnQuantizationBar(EETimeSynthEventQuantization QuantizationType, int32 NumBars, float Beat)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_TimeSynthController_Base_C_OnQuantizationBar Parms{};
...
void ABP_TimeSynthController_Base_C::OnQuantizationBeat(EETimeSynthEventQuantization QuantizationType, int32 NumBars, float Beat)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_TimeSynthController_Base_C_OnQuantizationBeat Parms{};
...
void ABP_TimeSynthController_Base_C::OnTimeSynthTrackComponentRegistered(const class UBP_TimeSynthTrackComponent_C*& Track)
{
	...
	Params::ABP_TimeSynthController_Base_C_OnTimeSynthTrackComponentRegistered Parms{};
...
void ABP_TimeSynthController_Base_C::PlayTransition(const struct FTimeSynth_TransitionData& Transition_Data, class UBP_TimeSynthTrackComponent_C* Queued_Track)
{
	...
	Params::ABP_TimeSynthController_Base_C_PlayTransition Parms{};

	Parms.Transition_Data = std::move(Transition_Data);
	*reinterpret_cast<void**>(&Parms.Queued_Track) = reinterpret_cast<void*>(Queued_Track);
...
void ABP_TimeSynthController_Base_C::QueueTrackStartInternal(class UBP_TimeSynthTrackComponent_C* NewTrack)
{
	...
	Params::ABP_TimeSynthController_Base_C_QueueTrackStartInternal Parms{};

	*reinterpret_cast<void**>(&Parms.NewTrack) = reinterpret_cast<void*>(NewTrack);
...
void ABP_TimeSynthController_Base_C::RequestTrackChange(class UBP_TimeSynthTrackComponent_C* TrackRequesting, bool* CanChangeTrack)
{
	...
	Params::ABP_TimeSynthController_Base_C_RequestTrackChange Parms{};

	*reinterpret_cast<void**>(&Parms.TrackRequesting) = reinterpret_cast<void*>(TrackRequesting);
...
void ABP_TimeSynthController_Base_C::SetVolumeGroup(int32 Index_0, float Volume_Multiplier)
{
	...
	Params::ABP_TimeSynthController_Base_C_SetVolumeGroup Parms{};
...
void ABP_TimeSynthController_Base_C::StopAllMusic(bool Play_Outro)
{
	...
	Params::ABP_TimeSynthController_Base_C_StopAllMusic Parms{};
