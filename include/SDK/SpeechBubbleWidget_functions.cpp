...
void USpeechBubbleWidget_C::ExecuteUbergraph_SpeechBubbleWidget(int32 EntryPoint)
{
	...
	Params::USpeechBubbleWidget_C_ExecuteUbergraph_SpeechBubbleWidget Parms{};
...
void USpeechBubbleWidget_C::InitFromObject(class UObject* InitObject)
{
	...
	Params::USpeechBubbleWidget_C_InitFromObject Parms{};

	*reinterpret_cast<void**>(&Parms.InitObject) = reinterpret_cast<void*>(InitObject);
