...
void UVoiceChannelHeaderButton_C::BP_OnItemExpansionChanged(bool bIsExpanded)
{
	...
	Params::UVoiceChannelHeaderButton_C_BP_OnItemExpansionChanged Parms{};
...
void UVoiceChannelHeaderButton_C::ExecuteUbergraph_VoiceChannelHeaderButton(int32 EntryPoint)
{
	...
	Params::UVoiceChannelHeaderButton_C_ExecuteUbergraph_VoiceChannelHeaderButton Parms{};
...
void UVoiceChannelHeaderButton_C::None_0(class UObject* ListItemObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("VoiceChannelHeaderButton_C", "None");

	Params::UVoiceChannelHeaderButton_C_None Parms{};
...
void UVoiceChannelHeaderButton_C::OnUpdateVisuals(bool bIsActiveAndListening, bool bIsActiveOrAvailable, bool bIsAvailableAndNotActive, bool bIsListening, bool bShowingRestriction)
{
	...
	Params::UVoiceChannelHeaderButton_C_OnUpdateVisuals Parms{};
