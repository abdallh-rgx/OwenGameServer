...
void UCrewPurchase_TileDetails_Tag_C::ExecuteUbergraph_CrewPurchase_TileDetails_Tag(int32 EntryPoint)
{
	...
	Params::UCrewPurchase_TileDetails_Tag_C_ExecuteUbergraph_CrewPurchase_TileDetails_Tag Parms{};
...
// Parameters:
// EECrewDetailsTag RewardTag (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool bIsOwnedTag (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCrewPurchase_TileDetails_Tag_C::OnTagSetup(EECrewDetailsTag RewardTag, bool bIsOwnedTag)
{
	static class UFunction* Func = nullptr;
	...
	Params::UCrewPurchase_TileDetails_Tag_C_OnTagSetup Parms{};
