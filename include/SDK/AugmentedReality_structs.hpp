...
// NumValues: 0x0005
enum class EEARTrackingState : uint8
{
	Unknown = 0,
	Tracking = 1,
	NotTracking = 2,
...
// NumValues: 0x0007
enum class EEARSessionConfigFlags : uint8
{
	None = 0,
	GenerateMeshData = 1,
...
// NumValues: 0x0004
enum class EEPlaneComponentDebugMode : uint8
{
	None = 0,
	ShowNetworkRole = 1,
...
// NumValues: 0x0004
enum class EEFaceComponentDebugMode : uint8
{
	None = 0,
	ShowEyeVectors = 1,
	ShowFaceMesh = 2,
...
// NumValues: 0x0005
enum class EEARFaceTransformMixing : uint8
{
	ComponentOnly = 0,
...
// NumValues: 0x0003
enum class EEImageComponentDebugMode : uint8
{
	None = 0,
	ShowDetectedImage = 1,
...
// NumValues: 0x0003
enum class EEQRCodeComponentDebugMode : uint8
{
	None = 0,
	ShowQRCode = 1,
...
// NumValues: 0x0003
enum class EEPoseComponentDebugMode : uint8
{
	None = 0,
	ShowSkeleton = 1,
...
// NumValues: 0x0003
enum class EEGeoAnchorComponentDebugMode : uint8
{
	None = 0,
	ShowGeoData = 1,
...
// NumValues: 0x0008
enum class EEARServiceAvailability : uint8
{
	UnknownError = 0,
	UnknownChecking = 1,
	UnknownTimedOut = 2,
...
// NumValues: 0x0005
enum class EEARServiceInstallRequestResult : uint8
{
	Installed = 0,
...
// NumValues: 0x0003
enum class EEARServicePermissionRequestResult : uint8
{
	Granted = 0,
	Denied = 1,
...
// NumValues: 0x0005
enum class EEARGeoTrackingState : uint8
{
	Initializing = 0,
	Localized = 1,
	Localizing = 2,
...
// NumValues: 0x000A
enum class EEARGeoTrackingStateReason : uint8
{
	None = 0,
...
// NumValues: 0x0005
enum class EEARGeoTrackingAccuracy : uint8
{
	Undetermined = 0,
	Low = 1,
	Medium = 2,
...
// NumValues: 0x0004
enum class EEARWorldAlignment : uint8
{
	Gravity = 0,
	GravityAndHeading = 1,
	Camera = 2,
...
// NumValues: 0x0009
enum class EEARSessionType : uint8
{
	None = 0,
	Orientation = 1,
	World = 2,
...
// NumValues: 0x0004
enum class EEARPlaneDetectionMode : uint8
{
	None = 0,
...
// NumValues: 0x0004
enum class EEARLightEstimationMode : uint8
{
	None = 0,
...
// NumValues: 0x0003
enum class EEARFrameSyncMode : uint8
{
...
// NumValues: 0x0004
enum class EEAREnvironmentCaptureProbeType : uint8
{
	None = 0,
	Manual = 1,
	Automatic = 2,
...
// NumValues: 0x0003
enum class EEARFaceTrackingUpdate : uint8
{
	CurvesAndGeo = 0,
	CurvesOnly = 1,
...
// NumValues: 0x0007
enum class EEARSessionTrackingFeature : uint8
{
	None = 0,
	PoseDetection2D = 1,
...
// NumValues: 0x0004
enum class EEARSceneReconstruction : uint8
{
	None = 0,
	MeshOnly = 1,
...
// NumValues: 0x0009
enum class EEARTextureType : uint8
{
	Unknown = 0,
	CameraImage = 1,
	CameraDepth = 2,
...
// NumValues: 0x0004
enum class EEARDepthQuality : uint8
{
	Unkown = 0,
	Low = 1,
	High = 2,
...
// NumValues: 0x0004
enum class EEARDepthAccuracy : uint8
{
	Unkown = 0,
	Approximate = 1,
	Accurate = 2,
...
// NumValues: 0x0003
enum class EEARFaceTrackingDirection : uint8
{
	FaceRelative = 0,
	FaceMirrored = 1,
...
// NumValues: 0x003E
enum class EEARFaceBlendShape : uint8
{
	EyeBlinkLeft = 0,
	EyeLookDownLeft = 1,
	EyeLookInLeft = 2,
...
// NumValues: 0x0006
enum class EEARCaptureType : uint8
{
	Camera = 0,
	QRCode = 1,
	SpatialMapping = 2,
...
// NumValues: 0x0006
enum class EEARLineTraceChannels : uint8
{
	None = 0,
	FeaturePoint = 1,
	GroundPlane = 2,
...
// NumValues: 0x0004
enum class EEARTrackingQuality : uint8
{
	NotTracking = 0,
	OrientationOnly = 1,
...
// NumValues: 0x0008
enum class EEARTrackingQualityReason : uint8
{
	None = 0,
	Initializing = 1,
	Relocalizing = 2,
...
// NumValues: 0x0008
enum class EEARSessionStatus : uint8
{
	NotStarted = 0,
	Running = 1,
	NotSupported = 2,
...
// NumValues: 0x0005
enum class EEARWorldMappingState : uint8
{
	NotAvailable = 0,
...
// NumValues: 0x0004
enum class EEARPlaneOrientation : uint8
{
	Horizontal = 0,
	Vertical = 1,
	Diagonal = 2,
...
// NumValues: 0x000F
enum class EEARObjectClassification : uint8
{
	NotApplicable = 0,
	Unknown = 1,
	Wall = 2,
...
// NumValues: 0x0004
enum class EEARSpatialMeshUsageFlags : uint8
{
	NotApplicable = 0,
	Visible = 1,
	Collision = 2,
...
// NumValues: 0x0003
enum class EEARJointTransformSpace : uint8
{
	Model = 0,
	ParentJoint = 1,
...
// NumValues: 0x0005
enum class EEARAltitudeSource : uint8
{
	Precise = 0,
	Coarse = 1,
	UserDefined = 2,
...
// NumValues: 0x0003
enum class EEARCandidateImageOrientation : uint8
{
	Landscape = 0,
	Portrait = 1,
...
public:
	...
	TArray<struct CoreUObject::FTransform> JointTransforms; // 0x0028(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<bool> IsJointTracked; // 0x0038(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	EEARJointTransformSpace JointTransformSpace; // 0x0048(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	EEARSessionStatus Status; // 0x0010(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	EEARLineTraceChannels TraceChannel; // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8 Pad_5[0xB]; // 0x0005(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	struct CoreUObject::FTransform LocalTransform; // 0x0010(0x0060)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
...
public:
	...
	struct CoreUObject::FTransform WorldTransform; // 0x0020(0x0060)(BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	EEARAltitudeSource AltitudeSource; // 0x008C(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8 Pad_18[0x8]; // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct CoreUObject::FTransform WorldTransform; // 0x0020(0x0060)(BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	EEARObjectClassification ObjectClassification; // 0x0080(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct CoreUObject::FTransform WorldTransform; // 0x0000(0x0060)(BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
#if defined(__clang__) || defined(__GNUC__)
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
...
public:
	...
	struct CoreUObject::FTransform WorldTransform; // 0x0000(0x0060)(BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct CoreUObject::FTransform> JointTransforms; // 0x0060(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
#if defined(__clang__) || defined(__GNUC__)
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
...
public:
	...
	struct FARSessionPayload SessionPayload; // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8 Pad_18[0x8]; // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct CoreUObject::FTransform WorldTransform; // 0x0020(0x0060)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	EEARObjectClassification ObjectClassification; // 0x00C0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
