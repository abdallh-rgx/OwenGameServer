...
void AGCN_RezOut_C::ExecuteUbergraph_GCN_RezOut(int32 EntryPoint)
{
	...
	Params::AGCN_RezOut_C_ExecuteUbergraph_GCN_RezOut Parms{};
...
void AGCN_RezOut_C::Set_Additional_Niagara_Parameters_on_Drone_FX(class UNiagaraComponent* Drone_FX)
{
	...
	Params::AGCN_RezOut_C_Set_Additional_Niagara_Parameters_on_Drone_FX Parms{};
...
void AGCN_RezOut_C::Set_Additional_Niagara_Parameters_on_Spawned_FX(class UNiagaraComponent* Spawned_Death_FX)
{
	...
	Params::AGCN_RezOut_C_Set_Additional_Niagara_Parameters_on_Spawned_FX Parms{};
...
void AGCN_RezOut_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::AGCN_RezOut_C_OnBurstGeneric Parms{};
