...
void UAthenaFunctionLibrary_C::AllOnSameTeam(const class AActor* Actor, const TArray<class AActor*>& ActorArray, class UObject* __WorldContext, bool* Result)
{
	...
	Params::UAthenaFunctionLibrary_C_AllOnSameTeam Parms{};
...
void UAthenaFunctionLibrary_C::CreateEnvironmentalKnockbackExplosion(const struct FVector& ExplosionSourcePoint, float ExplosionRadius, float Intensity, float MinKnockbackAngle, bool Reverse, class AActor* SpecificActor, class UObject* __WorldContext)
{
	...
	Params::UAthenaFunctionLibrary_C_CreateEnvironmentalKnockbackExplosion Parms{};
	...
	*reinterpret_cast<void**>(&Parms.SpecificActor) = reinterpret_cast<void*>(SpecificActor);
	*reinterpret_cast<void**>(&Parms.__WorldContext) = reinterpret_cast<void*>(__WorldContext);
...
void UAthenaFunctionLibrary_C::GetActorMeshExtents(class AActor* Actor, class UObject* __WorldContext, struct FVector* BoundingBoxExtents)
{
	...
	Params::UAthenaFunctionLibrary_C_GetActorMeshExtents Parms{};
...
void UAthenaFunctionLibrary_C::GetPlayerGroundedZ(class AFortPlayerPawn* PlayerPawn, class UObject* __WorldContext, float* Ground_Z)
{
	...
	Params::UAthenaFunctionLibrary_C_GetPlayerGroundedZ Parms{};
...
struct FGameplayEffectContextHandle UAthenaFunctionLibrary_C::MakeSimpleFortEffectContext(class AActor* Instigator, class AActor* Damage_Source, class UObject* __WorldContext)
{
	...
	Params::UAthenaFunctionLibrary_C_MakeSimpleFortEffectContext Parms{};

	*reinterpret_cast<void**>(&Parms.Instigator) = reinterpret_cast<void*>(Instigator);
	*reinterpret_cast<void**>(&Parms.Damage_Source) = reinterpret_cast<void*>(Damage_Source);
	*reinterpret_cast<void**>(&Parms.__WorldContext) = reinterpret_cast<void*>(__WorldContext);
...
bool UAthenaFunctionLibrary_C::RowToBool(const struct FScalableFloat& Input, float Level, class UObject* __WorldContext)
{
	...
	Params::UAthenaFunctionLibrary_C_RowToBool Parms{};
...
void UAthenaFunctionLibrary_C::SetPOITextWithContextTag(const struct FGameplayTag& POI_Tag, const struct FGameplayTagContainer& Context_Tags, class UObject* __WorldContext)
{
	...
	Params::UAthenaFunctionLibrary_C_SetPOITextWithContextTag Parms{};
...
bool UAthenaFunctionLibrary_C::ShouldAllowDeathEffects(const struct FGameplayTagContainer& Damage_Or_Death_Tags, class UObject* __WorldContext)
{
	...
	Params::UAthenaFunctionLibrary_C_ShouldAllowDeathEffects Parms{};
...
// EEFortPickupSourceTypeFlag SourceType (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EEFortPickupSpawnSource Source (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaFunctionLibrary_C::SpawnLootFromTable(const class FName TierGroupName, const int32 WorldLevel, const int32 ForcedLootTier, const struct FVector& Position, const struct FVector& Direction, int32 OverrideMaxStackCount, bool bToss, bool bRandomRotation, bool bBlockedFromAutoPickup, int32 PickupInstigatorHandle, EEFortPickupSourceTypeFlag SourceType, EEFortPickupSpawnSource Source, class AFortPlayerController* OptionalOwnerPC, bool bPickupOnlyRelevantToOwner, class UObject* __WorldContext, TArray<class AFortPickup*>* ItemPickupsSpawned)
{
	...
	Params::UAthenaFunctionLibrary_C_SpawnLootFromTable Parms{};
	...
	Parms.Source = Source;
	*reinterpret_cast<void**>(&Parms.OptionalOwnerPC) = reinterpret_cast<void*>(OptionalOwnerPC);
...
void UAthenaFunctionLibrary_C::UnclampedLerp(float A, float B, float Alpha, class UObject* __WorldContext, float* Return_Value)
{
	...
	Params::UAthenaFunctionLibrary_C_UnclampedLerp Parms{};
