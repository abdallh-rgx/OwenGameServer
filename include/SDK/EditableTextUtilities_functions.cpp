...
void UEditableTextUtilities_C::CheckIfNeedsTrimming(const class FText& Text, int32 Limit, class UObject* __WorldContext, class FText* TrimmedText, bool* WasTrimmed)
{
	...
	Params::UEditableTextUtilities_C_CheckIfNeedsTrimming Parms{};
...
void UEditableTextUtilities_C::LimitTextLength(class UWidget* EditableTextWidget, int32 Length, class UObject* __WorldContext, bool* WasTrimmed)
{
	...
	Params::UEditableTextUtilities_C_LimitTextLength Parms{};

	*reinterpret_cast<void**>(&Parms.EditableTextWidget) = reinterpret_cast<void*>(EditableTextWidget);
	Parms.Length = Length;
	*reinterpret_cast<void**>(&Parms.__WorldContext) = reinterpret_cast<void*>(__WorldContext);
