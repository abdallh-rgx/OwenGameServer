...
void AGCNL_RidingSprint_SpeedLines_C::ExecuteUbergraph_GCNL_RidingSprint_SpeedLines(int32 EntryPoint)
{
	...
	Params::AGCNL_RidingSprint_SpeedLines_C_ExecuteUbergraph_GCNL_RidingSprint_SpeedLines Parms{};
...
void AGCNL_RidingSprint_SpeedLines_C::OnApplicationGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	Params::AGCNL_RidingSprint_SpeedLines_C_OnApplicationGeneric Parms{};
...
void AGCNL_RidingSprint_SpeedLines_C::OnRemovalGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	Params::AGCNL_RidingSprint_SpeedLines_C_OnRemovalGeneric Parms{};
