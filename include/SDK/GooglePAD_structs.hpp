...
// NumValues: 0x000F
enum class EEGooglePADErrorCode : uint8
{
...
// NumValues: 0x000E
enum class EEGooglePADDownloadStatus : uint8
{
	AssetPack_UNKNOWN = 0,
...
// NumValues: 0x0005
enum class EEGooglePADStorageMethod : uint8
{
...
// NumValues: 0x0005
enum class EEGooglePADCellularDataConfirmStatus : uint8
{
