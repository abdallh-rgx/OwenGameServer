...
struct UGCN_Athena_HidingProp_HayStack_Exit_C_OnBurst final
{
public:
	UGCN_Athena_HidingProp_HayStack_Exit_C_OnBurst() {}
...
#endif
DUMPER7_ASSERTS_UGCN_Athena_HidingProp_HayStack_Exit_C_OnBurst;
#if defined(__clang__) || defined(__GNUC__)
