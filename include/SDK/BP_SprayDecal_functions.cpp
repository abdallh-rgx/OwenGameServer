...
void ABP_SprayDecal_C::ExecuteUbergraph_BP_SprayDecal(int32 EntryPoint)
{
	...
	Params::ABP_SprayDecal_C_ExecuteUbergraph_BP_SprayDecal Parms{};
...
struct FUniqueNetIdRepl ABP_SprayDecal_C::GetInstigatorPlayerId()
{
	...
	Params::ABP_SprayDecal_C_GetInstigatorPlayerId Parms{};
...
// Parameters:
// float InDecalSize (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UAthenaSprayItemDefinition* InSprayAsset (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AFortPlayerController* InSpawningPlayerController (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_SprayDecal_C::Initialize_Spray_Spawned_from_Gameplay(float InDecalSize, class UAthenaSprayItemDefinition* InSprayAsset, class AFortPlayerController* InSpawningPlayerController)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_SprayDecal_C_Initialize_Spray_Spawned_from_Gameplay Parms{};

	Parms.InDecalSize = InDecalSize;
	*reinterpret_cast<void**>(&Parms.InSprayAsset) = reinterpret_cast<void*>(InSprayAsset);
	*reinterpret_cast<void**>(&Parms.InSpawningPlayerController) = reinterpret_cast<void*>(InSpawningPlayerController);
...
void ABP_SprayDecal_C::OnLoaded_F8AB699B4D8DD22B5A0409B608B7D6FA(class UObject* Loaded)
{
	...
	Params::ABP_SprayDecal_C_OnLoaded_F8AB699B4D8DD22B5A0409B608B7D6FA Parms{};
...
void ABP_SprayDecal_C::OnLoaded_F925FF00475A018319C73E9FB1540BC6(class UObject* Loaded)
{
	...
	Params::ABP_SprayDecal_C_OnLoaded_F925FF00475A018319C73E9FB1540BC6 Parms{};
...
void ABP_SprayDecal_C::OnNearbyTrapPlaced(class ABuildingTrap* Trap, bool bDetatched)
{
	...
	Params::ABP_SprayDecal_C_OnNearbyTrapPlaced Parms{};

	*reinterpret_cast<void**>(&Parms.Trap) = reinterpret_cast<void*>(Trap);
...
void ABP_SprayDecal_C::OnNearbyWallDamaged(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	...
	Params::ABP_SprayDecal_C_OnNearbyWallDamaged Parms{};
...
void ABP_SprayDecal_C::OnNearbyWallDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	...
	Params::ABP_SprayDecal_C_OnNearbyWallDied Parms{};
...
void ABP_SprayDecal_C::OnReady_B252FED346EAB98D54D786BD15C1CC7B(class AFortGameStateAthena* GameState, const class UFortPlaylist* Playlist, const struct FGameplayTagContainer& PlaylistContextTags)
{
	...
	Params::ABP_SprayDecal_C_OnReady_B252FED346EAB98D54D786BD15C1CC7B Parms{};
...
void ABP_SprayDecal_C::OnWallDestoryed(class AActor* DestroyedActor)
{
	...
	Params::ABP_SprayDecal_C_OnWallDestoryed Parms{};
