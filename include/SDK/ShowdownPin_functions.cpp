...
void UShowdownPin_C::PreConstruct(bool IsDesignTime_PreConstruct)
{
	static class UFunction* Func = nullptr;
	...
	Params::UShowdownPin_C_PreConstruct Parms{};
...
void UShowdownPin_C::ExecuteUbergraph_ShowdownPin(int32 EntryPoint)
{
	...
	Params::UShowdownPin_C_ExecuteUbergraph_ShowdownPin Parms{};
...
void UShowdownPin_C::EventSetTier(int32 Score)
{
	...
	Params::UShowdownPin_C_EventSetTier Parms{};
...
void UShowdownPin_C::EventFixPts(int32 Points)
{
	...
	Params::UShowdownPin_C_EventFixPts Parms{};
...
void UShowdownPin_C::ChooseScoreToDisplay(int32* ScoreToDisplay)
{
	...
	Params::UShowdownPin_C_ChooseScoreToDisplay Parms{};
