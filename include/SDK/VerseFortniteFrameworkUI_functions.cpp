...
void UVerseFortniteHUDWidgetBase::OnUpdateVisibleState(bool bEnabled)
{
	...
	Params::UVerseFortniteHUDWidgetBase_OnUpdateVisibleState Parms{};
...
void UHUDSimpleMessageWidget::OnUpdateMessage(const class FString& NewMessage)
{
	...
	Params::UHUDSimpleMessageWidget_OnUpdateMessage Parms{};
...
void UHUDScoreboardWidgetBase::OnUpdateRounds(uint32 CurrentRound, uint32 NumberOfRounds)
{
	...
	Params::UHUDScoreboardWidgetBase_OnUpdateRounds Parms{};
...
void UVerseFortniteActivatableWidgetBase::OnEnabledChanged(bool bEnabled)
{
	...
	Params::UVerseFortniteActivatableWidgetBase_OnEnabledChanged Parms{};
...
// Parameters:
// EEGameOverMessageType ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

EEGameOverMessageType UHUDGameOverWidgetBase::GetGameOverType()
{
	static class UFunction* Func = nullptr;
	...
	Params::UHUDGameOverWidgetBase_GetGameOverType Parms{};
...
void UHUDGameOverWidgetBase::HandleGameOverStateChanged(class UHUDGameOverComponentBase* GameOverComponent)
{
	...
	Params::UHUDGameOverWidgetBase_HandleGameOverStateChanged Parms{};

	*reinterpret_cast<void**>(&Parms.GameOverComponent) = reinterpret_cast<void*>(GameOverComponent);
...
void UHUDCountDownWidget::OnStartCountDown(const float SecondsRemaining, const int32 CurrentRound)
{
	...
	Params::UHUDCountDownWidget_OnStartCountDown Parms{};
