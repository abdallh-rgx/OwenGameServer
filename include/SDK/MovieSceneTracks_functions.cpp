...
class UMovieSceneAsyncAction_SequencePrediction* UMovieSceneAsyncAction_SequencePrediction::PredictLocalTransformAtFrame(class UMovieSceneSequencePlayer* Player, class USceneComponent* TargetComponent, const struct FFrameTime& FrameTime)
{
	...
	*reinterpret_cast<void**>(&Parms.TargetComponent) = reinterpret_cast<void*>(TargetComponent);
...
// Parameters:
// EELevelVisibility InVisibility (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMovieSceneLevelVisibilitySection::SetVisibility(EELevelVisibility InVisibility)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// EELevelVisibility ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

EELevelVisibility UMovieSceneLevelVisibilitySection::GetVisibility() const
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// EEDataLayerRuntimeState InDesiredState (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMovieSceneDataLayerSection::SetDesiredState(EEDataLayerRuntimeState InDesiredState)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// EEDataLayerRuntimeState InPrerollState (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMovieSceneDataLayerSection::SetPrerollState(EEDataLayerRuntimeState InPrerollState)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// EEDataLayerRuntimeState ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

EEDataLayerRuntimeState UMovieSceneDataLayerSection::GetDesiredState() const
{
	static class UFunction* Func = nullptr;
...
EEDataLayerRuntimeState UMovieSceneDataLayerSection::GetPrerollState() const
{
	static class UFunction* Func = nullptr;
...
void UMovieSceneParameterSection::AddTransformParameterKey(class FName InParameterName, const struct FFrameNumber& InTime, const struct CoreUObject::FTransform& InValue)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject::FTransform IMovieSceneTransformOrigin::BP_GetTransformOrigin() const
{
	static class UFunction* Func = nullptr;
	...
	Params::IMovieSceneTransformOrigin_BP_GetTransformOrigin Parms{};
...
void UMovieSceneAudioSection::SetSound(class USoundBase* InSound)
{
	...
	*reinterpret_cast<void**>(&Parms.InSound) = reinterpret_cast<void*>(InSound);
