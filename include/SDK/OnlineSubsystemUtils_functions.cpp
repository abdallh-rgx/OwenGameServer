...
// (Net, NetReliable, Native, Event, Public, NetClient)
// Parameters:
// EESpectatorReservationResult ReservationResponse (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ASpectatorBeaconClient::ClientCancelReservationResponse(EESpectatorReservationResult ReservationResponse)
{
	static class UFunction* Func = nullptr;
...
void ASpectatorBeaconClient::ClientReservationResponse(EESpectatorReservationResult ReservationResponse)
{
	static class UFunction* Func = nullptr;
...
// class APlayerController* PlayerController (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class FString& MatchID (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EEMPMatchOutcome Outcome (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UQuitMatchCallbackProxy* UQuitMatchCallbackProxy::QuitMatch(class UObject* WorldContextObject, class APlayerController* PlayerController, const class FString& MatchID, EEMPMatchOutcome Outcome, int32 TurnTimeoutInSeconds)
{
	static class UFunction* Func = nullptr;
...
// (Net, NetReliable, Native, Event, Public, NetClient)
// Parameters:
// EEPartyReservationResult ReservationResponse (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void APartyBeaconClient::ClientCancelReservationResponse(EEPartyReservationResult ReservationResponse)
{
	static class UFunction* Func = nullptr;
...
void APartyBeaconClient::ClientReservationResponse(EEPartyReservationResult ReservationResponse)
{
	static class UFunction* Func = nullptr;
...
class UInAppPurchaseRestoreCallbackProxy* UInAppPurchaseRestoreCallbackProxy::CreateProxyObjectForInAppPurchaseRestore(const TArray<struct FInAppPurchaseProductRequest>& ConsumableProductFlags, class APlayerController* PlayerController)
{
	...
	Params::UInAppPurchaseRestoreCallbackProxy_CreateProxyObjectForInAppPurchaseRestore Parms{};
...
class UInAppPurchaseQueryCallbackProxy* UInAppPurchaseQueryCallbackProxy::CreateProxyObjectForInAppPurchaseQuery(class APlayerController* PlayerController, const TArray<class FString>& ProductIdentifiers)
{
	...
	Params::UInAppPurchaseQueryCallbackProxy_CreateProxyObjectForInAppPurchaseQuery Parms{};
...
class UInAppPurchaseCallbackProxy* UInAppPurchaseCallbackProxy::CreateProxyObjectForInAppPurchase(class APlayerController* PlayerController, const struct FInAppPurchaseProductRequest& ProductRequest)
{
	...
	Params::UInAppPurchaseCallbackProxy_CreateProxyObjectForInAppPurchase Parms{};
...
// TScriptInterface<class ITurnBasedMatchInterface> MatchActor (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class FString& MatchID (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EEMPMatchOutcome LocalPlayerOutcome (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EEMPMatchOutcome OtherPlayersOutcome (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UEndMatchCallbackProxy* UEndMatchCallbackProxy::EndMatch(class UObject* WorldContextObject, class APlayerController* PlayerController, TScriptInterface<class ITurnBasedMatchInterface> MatchActor, const class FString& MatchID, EEMPMatchOutcome LocalPlayerOutcome, EEMPMatchOutcome OtherPlayersOutcome)
{
	static class UFunction* Func = nullptr;
