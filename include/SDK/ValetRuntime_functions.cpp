...
void UFortDagwoodVehicleManager::CustomHandleActorStreamedInEditor(class AActor* SourceActor)
{
	...
	Params::UFortDagwoodVehicleManager_CustomHandleActorStreamedInEditor Parms{};
...
void UFortDagwoodVehicleManager::OnVehicleSpawned(class AFortAthenaVehicle* Vehicle)
{
	...
	Params::UFortDagwoodVehicleManager_OnVehicleSpawned Parms{};
...
void UFortDagwoodVehicleManager::OnVehicleSpawnsUpdated(class UFortVehicleItemDefinition* VehicleItemDef, TArray<class AActor*>* SpawnedVehicles, int32 NewVehicleCount)
{
	...
	Params::UFortDagwoodVehicleManager_OnVehicleSpawnsUpdated Parms{};

	*reinterpret_cast<void**>(&Parms.VehicleItemDef) = reinterpret_cast<void*>(VehicleItemDef);
...
const struct FDagwoodRuntimeModifiers AFortDagwoodVehicle::GetCurrentDagwoodRuntimeProperties()
{
	...
	Params::AFortDagwoodVehicle_GetCurrentDagwoodRuntimeProperties Parms{};
...
void AFortDagwoodVehicle::HandleCurrentPlaylistLoaded(class FName PlaylistName, const struct FGameplayTagContainer& PlaylistContextTags)
{
	...
	Params::AFortDagwoodVehicle_HandleCurrentPlaylistLoaded Parms{};
...
void AFortDagwoodVehicle::MakeOperable(bool bAddGas)
{
	...
	Params::AFortDagwoodVehicle_MakeOperable Parms{};
...
void AFortDagwoodVehicle::OnClientBeginAltInteract(class AFortPawn* Pawn)
{
	...
	Params::AFortDagwoodVehicle_OnClientBeginAltInteract Parms{};
...
void AFortDagwoodVehicle::OnDestroyedPropFromCollision(const class ABuildingActor* BuildingHitActor)
{
	...
	Params::AFortDagwoodVehicle_OnDestroyedPropFromCollision Parms{};

	*reinterpret_cast<const void**>(&Parms.BuildingHitActor) = reinterpret_cast<const void*>(BuildingHitActor);
...
void AFortDagwoodVehicle::OnHoldSelfDestructStarted(class AFortPawn* DriverPawn, const float ExitDuration)
{
	...
	Params::AFortDagwoodVehicle_OnHoldSelfDestructStarted Parms{};

	*reinterpret_cast<void**>(&Parms.DriverPawn) = reinterpret_cast<void*>(DriverPawn);
...
void AFortDagwoodVehicle::OnHoldSelfDestructStopped(class AFortPawn* DriverPawn)
{
	...
	Params::AFortDagwoodVehicle_OnHoldSelfDestructStopped Parms{};
...
void AFortDagwoodVehicle::OnInoperableChanged(bool bInoperable)
{
	...
	Params::AFortDagwoodVehicle_OnInoperableChanged Parms{};
...
void AFortDagwoodVehicle::OnPoppedTire(const int32 TireIndex, const bool bFakeTire)
{
	...
	Params::AFortDagwoodVehicle_OnPoppedTire Parms{};
...
void AFortDagwoodVehicle::OnRep_DagwoodRuntimeModifiers(const struct FDagwoodRuntimeModifiers& PrevMods)
{
	...
	Params::AFortDagwoodVehicle_OnRep_DagwoodRuntimeModifiers Parms{};
...
// (Final, Native, Private, HasOutParams)
// Parameters:
// const TArray<EETireStates>& PrevTireStates (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void AFortDagwoodVehicle::OnRep_FakeTires(const TArray<EETireStates>& PrevTireStates)
{
	static class UFunction* Func = nullptr;
	...
	Params::AFortDagwoodVehicle_OnRep_FakeTires Parms{};
...
void AFortDagwoodVehicle::OnRep_Tires(const TArray<EETireStates>& PrevTireStates)
{
	static class UFunction* Func = nullptr;
	...
	Params::AFortDagwoodVehicle_OnRep_Tires Parms{};
...
void AFortDagwoodVehicle::OnRimScrapeDamage(int32 TireIndex)
{
	...
	Params::AFortDagwoodVehicle_OnRimScrapeDamage Parms{};
...
void AFortDagwoodVehicle::OnServerAltInteract(class AFortPawn* Pawn)
{
	...
	Params::AFortDagwoodVehicle_OnServerAltInteract Parms{};
...
void AFortDagwoodVehicle::OnTickAudioController(float DeltaTime)
{
	...
	Params::AFortDagwoodVehicle_OnTickAudioController Parms{};
...
void AFortDagwoodVehicle::OnTickAudioFade(float FadeParam)
{
	...
	Params::AFortDagwoodVehicle_OnTickAudioFade Parms{};
...
void AFortDagwoodVehicle::ServerAddRuntimeGearsInfo(const struct FRuntimeGearInfo& GearInfo)
{
	...
	Params::AFortDagwoodVehicle_ServerAddRuntimeGearsInfo Parms{};
...
void AFortDagwoodVehicle::ServerSetDestructionInfo(const float InSelfDestructTime, const float InMaxTimeZeroHealth, const float InMaxTimeSelfDestructCleanup, const float InMaxTimeExplosion)
{
	...
	Params::AFortDagwoodVehicle_ServerSetDestructionInfo Parms{};
...
void AFortDagwoodVehicle::ServerSetFadeDuration(const float NewFadeDuration)
{
	...
	Params::AFortDagwoodVehicle_ServerSetFadeDuration Parms{};
...
void AFortDagwoodVehicle::ServerSetRuntimeBoostInfo(const struct FRuntimeBoostInfo& BoostInfo)
{
	...
	Params::AFortDagwoodVehicle_ServerSetRuntimeBoostInfo Parms{};
...
void AFortDagwoodVehicle::ServerSetRuntimeDriveInfo(float MaxIncline, float MaxTilt)
{
	...
	Params::AFortDagwoodVehicle_ServerSetRuntimeDriveInfo Parms{};
...
void AFortDagwoodVehicle::ServerSetRuntimeFuelInfo(const struct FRuntimeFuelInfo& FuelInfo)
{
	...
	Params::AFortDagwoodVehicle_ServerSetRuntimeFuelInfo Parms{};
...
void AFortDagwoodVehicle::ServerSetRuntimeGravity(float GravMult)
{
	...
	Params::AFortDagwoodVehicle_ServerSetRuntimeGravity Parms{};
...
void AFortDagwoodVehicle::ServerSetRuntimeSpringsInfo(const struct FRuntimeSpringsInfo& SpringsInfo)
{
	...
	Params::AFortDagwoodVehicle_ServerSetRuntimeSpringsInfo Parms{};
...
void AFortDagwoodVehicle::SetDamageInfoOnServer(const bool bInDamageFriendlyVehicles, const bool bInDamageOtherVehicles, const bool bInDamageOwnVehicle, const bool bInDamageAllowedFromOtherVehicle)
{
	...
	Params::AFortDagwoodVehicle_SetDamageInfoOnServer Parms{};
...
void AFortDagwoodVehicle::SetValetAudioController(class AFortValetAudioController* ValetAudio_0)
{
	...
	Params::AFortDagwoodVehicle_SetValetAudioController Parms{};

	*reinterpret_cast<void**>(&Parms.ValetAudio_0) = reinterpret_cast<void*>(ValetAudio_0);
...
bool AFortDagwoodVehicle::ForwardOrReverseInputPressed() const
{
	...
	Params::AFortDagwoodVehicle_ForwardOrReverseInputPressed Parms{};
...
float AFortDagwoodVehicle::GetBumpiness() const
{
	...
	Params::AFortDagwoodVehicle_GetBumpiness Parms{};
...
float AFortDagwoodVehicle::GetMiddleAxleForwardAdjust() const
{
	...
	Params::AFortDagwoodVehicle_GetMiddleAxleForwardAdjust Parms{};
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// EETireLocations TireIndex (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

float AFortDagwoodVehicle::GetTireHealthPercent(EETireLocations TireIndex) const
{
	static class UFunction* Func = nullptr;
	...
	Params::AFortDagwoodVehicle_GetTireHealthPercent Parms{};
...
bool AFortDagwoodVehicle::GetTireState(int32 TireIndex) const
{
	...
	Params::AFortDagwoodVehicle_GetTireState Parms{};
...
// Parameters:
// EETireLocations TireIndex (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EETireSurfaces ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

EETireSurfaces AFortDagwoodVehicle::GetTireSurface(EETireLocations TireIndex) const
{
	static class UFunction* Func = nullptr;
	...
	Params::AFortDagwoodVehicle_GetTireSurface Parms{};
...
bool AFortDagwoodVehicle::IsNativeBPTickEnabled() const
{
	...
	Params::AFortDagwoodVehicle_IsNativeBPTickEnabled Parms{};
...
bool AFortDagwoodVehicle::IsOnLandscape() const
{
	...
	Params::AFortDagwoodVehicle_IsOnLandscape Parms{};
...
bool AFortDagwoodVehicle::IsOnRoad() const
{
	...
	Params::AFortDagwoodVehicle_IsOnRoad Parms{};
...
bool AFortDagwoodVehicle::IsTireSkidding(const float MinSpeedForSkid, const float AngleForSkid, const float SpeedForPeelout, const float SpeedForBraking) const
{
	...
	Params::AFortDagwoodVehicle_IsTireSkidding Parms{};
...
float AFortDagwoodVehicle::NativeCalculateAccelRumbleIntensity(float MaxIntensity) const
{
	...
	Params::AFortDagwoodVehicle_NativeCalculateAccelRumbleIntensity Parms{};
...
void UFortContextualTutorial_VehicleValetLowFuel::HandleVehicleStateChanged(class AFortPlayerPawn* PlayerPawn, class AActor* NewVehicle, class AActor* OldVehicle)
{
	...
	Params::UFortContextualTutorial_VehicleValetLowFuel_HandleVehicleStateChanged Parms{};

	*reinterpret_cast<void**>(&Parms.PlayerPawn) = reinterpret_cast<void*>(PlayerPawn);
	*reinterpret_cast<void**>(&Parms.NewVehicle) = reinterpret_cast<void*>(NewVehicle);
	*reinterpret_cast<void**>(&Parms.OldVehicle) = reinterpret_cast<void*>(OldVehicle);
...
void AFortAthenaMutator_OverrideValetVehicleParameters::OnPlaylistLoaded(class FName PlaylistName, const struct FGameplayTagContainer& PlaylistContainerTags)
{
	...
	Params::AFortAthenaMutator_OverrideValetVehicleParameters_OnPlaylistLoaded Parms{};
...
void AFortValetAudioController::CacheValetVehicle(class AFortDagwoodVehicle* InVehicle)
{
	...
	Params::AFortValetAudioController_CacheValetVehicle Parms{};

	*reinterpret_cast<void**>(&Parms.InVehicle) = reinterpret_cast<void*>(InVehicle);
...
void AFortValetAudioController::OnSuspensionCollision_Native(bool* OutResult, float* OutMagnitude)
{
	...
	Params::AFortValetAudioController_OnSuspensionCollision_Native Parms{};
...
void AFortValetAudioController::OnTireModApplied(const struct FTireInfo& AppliedTireMod)
{
	...
	Params::AFortValetAudioController_OnTireModApplied Parms{};
...
void UDagwoodNetworkPhysicsComponent::SetPendingInputCmd(const struct FFortDagwoodCmd& In)
{
	...
	Params::UDagwoodNetworkPhysicsComponent_SetPendingInputCmd Parms{};
...
void UDagwoodNetworkPhysicsComponent::SetState_GT(const struct FDagwoodInPersistent& In)
{
	...
	Params::UDagwoodNetworkPhysicsComponent_SetState_GT Parms{};
...
struct FFortDagwoodCmd UDagwoodNetworkPhysicsComponent::GetPendingInputCmd() const
{
	...
	Params::UDagwoodNetworkPhysicsComponent_GetPendingInputCmd Parms{};
...
struct FDagwoodInPersistent UDagwoodNetworkPhysicsComponent::GetState_GT() const
{
	...
	Params::UDagwoodNetworkPhysicsComponent_GetState_GT Parms{};
...
struct FDagwoodState_PT UDagwoodNetworkPhysicsComponent::GetState_PT() const
{
	...
	Params::UDagwoodNetworkPhysicsComponent_GetState_PT Parms{};
