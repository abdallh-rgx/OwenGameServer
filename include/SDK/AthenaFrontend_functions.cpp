...
void UAthenaFrontend_C::UpdatePttVisibility(EEPTTState PTTState)
{
	...
	Params::UAthenaFrontend_C_UpdatePttVisibility Parms{};
...
void UAthenaFrontend_C::StartTrailerTransitionAudioCheck(class UMediaPlayer* MediaPlayer_StartTrailerTransitionAudioCheck)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAthenaFrontend_C_StartTrailerTransitionAudioCheck Parms{};
...
void UAthenaFrontend_C::SetOverlayTitleBarVisibility(bool Visible)
{
	...
	Params::UAthenaFrontend_C_SetOverlayTitleBarVisibility Parms{};
...
void UAthenaFrontend_C::SetChatWidgetVisibility(bool Visible)
{
	...
	Params::UAthenaFrontend_C_SetChatWidgetVisibility Parms{};
...
void UAthenaFrontend_C::OnTrailerMediaOpened(const class FString& OpenedURL)
{
	...
	Params::UAthenaFrontend_C_OnTrailerMediaOpened Parms{};
...
void UAthenaFrontend_C::OnSetFrontendVisibilityMode(EEFrontendVisibilityMode InFrontendVisibilityMode_OnSetFrontendVisibilityMode)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAthenaFrontend_C_OnSetFrontendVisibilityMode Parms{};
...
void UAthenaFrontend_C::ExecuteUbergraph_AthenaFrontend(int32 EntryPoint)
{
	...
	Params::UAthenaFrontend_C_ExecuteUbergraph_AthenaFrontend Parms{};
...
// Parameters:
// const class FText& DebugFlowText_DisplayDebugFlowText (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UAthenaFrontend_C::DisplayDebugFlowText(const class FText& DebugFlowText_DisplayDebugFlowText)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAthenaFrontend_C_DisplayDebugFlowText Parms{};

	Parms.DebugFlowText_DisplayDebugFlowText = std::move(DebugFlowText_DisplayDebugFlowText);
...
void UAthenaFrontend_C::BndEvt__ButtonToggleChat_K2Node_ComponentBoundEvent_39_CommonSelectedStateChanged__DelegateSignature(class UCommonButtonLegacy* Button, bool Selected)
{
	...
	Params::UAthenaFrontend_C_BndEvt__ButtonToggleChat_K2Node_ComponentBoundEvent_39_CommonSelectedStateChanged__DelegateSignature Parms{};
