...
void UCinematic_C::ClearMovieWidget(class UFortMovieWidget*& MovieWidgetToClear)
{
	...
	Params::UCinematic_C_ClearMovieWidget Parms{};
...
void UCinematic_C::ClearOldSubtitlesIfNecessary(bool NewSubtitlesExist, class UFortMediaSubtitlesPlayer* NewSubtitles)
{
	...
	Params::UCinematic_C_ClearOldSubtitlesIfNecessary Parms{};

	Parms.NewSubtitlesExist = NewSubtitlesExist;
	*reinterpret_cast<void**>(&Parms.NewSubtitles) = reinterpret_cast<void*>(NewSubtitles);
...
void UCinematic_C::ExecuteUbergraph_Cinematic(int32 EntryPoint)
{
	...
	Params::UCinematic_C_ExecuteUbergraph_Cinematic Parms{};
...
void UCinematic_C::GetAudioTrackIndex(int32* AudioTrack)
{
	...
	Params::UCinematic_C_GetAudioTrackIndex Parms{};
...
void UCinematic_C::HandleClientEvent_QueueCinematic(class UObject* EventSource, class UObject* EventFocus, const struct FFortClientEvent& ClientEvent)
{
	...
	Params::UCinematic_C_HandleClientEvent_QueueCinematic Parms{};
...
void UCinematic_C::HandleClientEvent_SkipCinematic(class UObject* EventSource, class UObject* EventFocus, const struct FFortClientEvent& ClientEvent)
{
	...
	Params::UCinematic_C_HandleClientEvent_SkipCinematic Parms{};
...
// Parameters:
// EEFortUIState PreviousUIState (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCinematic_C::OnEnterState(EEFortUIState PreviousUIState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UCinematic_C_OnEnterState Parms{};
...
// (Event, Public, BlueprintEvent)
// Parameters:
// EEFortUIState NextUIState (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCinematic_C::OnExitState(EEFortUIState NextUIState)
{
	static class UFunction* Func = nullptr;
	...
	Params::UCinematic_C_OnExitState Parms{};
...
class UWidget* UCinematic_C::PopContentWidgetInternal(const struct FContentPushState& State)
{
	...
	Params::UCinematic_C_PopContentWidgetInternal Parms{};
...
void UCinematic_C::PushContentWidgetInternal(class UWidget* Widget, const struct FContentPushState& State)
{
	...
	Params::UCinematic_C_PushContentWidgetInternal Parms{};
...
void UCinematic_C::SetMoviePlaying(bool MoviePlaying)
{
	...
	Params::UCinematic_C_SetMoviePlaying Parms{};
...
void UCinematic_C::Show_Movie(class UMediaPlayer* MediaPlayer, class UMediaSource* MediaSource)
{
	...
	Params::UCinematic_C_Show_Movie Parms{};

	*reinterpret_cast<void**>(&Parms.MediaPlayer) = reinterpret_cast<void*>(MediaPlayer);
