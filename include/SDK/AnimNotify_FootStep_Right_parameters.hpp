...
struct UAnimNotify_FootStep_Right_C_Received_Notify final
{
public:
	UAnimNotify_FootStep_Right_C_Received_Notify() {}
...
#endif
DUMPER7_ASSERTS_UAnimNotify_FootStep_Right_C_Received_Notify;
#if defined(__clang__) || defined(__GNUC__)
