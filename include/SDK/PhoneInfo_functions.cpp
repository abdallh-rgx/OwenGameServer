...
void UPhoneInfo_C::ChargingIconTimerUpdate()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PhoneInfo_C", "ChargingIconTimerUpdate");
...
void UPhoneInfo_C::ExecuteUbergraph_PhoneInfo(int32 EntryPoint)
{
	...
	Params::UPhoneInfo_C_ExecuteUbergraph_PhoneInfo Parms{};
...
// Parameters:
// bool bInLowPerformanceMode (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UPhoneInfo_C::On_Low_Perf_Mode(bool bInLowPerformanceMode)
{
	...
	Params::UPhoneInfo_C_On_Low_Perf_Mode Parms{};
