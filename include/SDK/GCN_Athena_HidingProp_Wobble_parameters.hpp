...
// StructAlignedSize(0x0270) StructUnalignedSize(0x026C) StructAlignment(0x0010)
// 0x0270 (0x0270 - 0x0000)
struct UGCN_Athena_HidingProp_Wobble_C_OnBurst final
{
public:
	UGCN_Athena_HidingProp_Wobble_C_OnBurst() {}
	...
	struct CoreUObject::FTransform CallFunc_GetTransform_ReturnValue; // 0x01E0(0x0060)(ConstParm, IsPlainOldData, NoDestructor)
...
#endif
DUMPER7_ASSERTS_UGCN_Athena_HidingProp_Wobble_C_OnBurst;
#if defined(__clang__) || defined(__GNUC__)
