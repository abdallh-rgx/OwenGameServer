...
// Parameters:
// float AudioPitchInterpSpeed (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AGCNL_PlayerIsRiding_C::AudioOnJump(float AudioPitchInterpSpeed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_PlayerIsRiding_C", "AudioOnJump");

	Params::AGCNL_PlayerIsRiding_C_AudioOnJump Parms{};

	Parms.AudioPitchInterpSpeed = AudioPitchInterpSpeed;
...
void AGCNL_PlayerIsRiding_C::ExecuteUbergraph_GCNL_PlayerIsRiding(int32 EntryPoint)
{
	...
	Params::AGCNL_PlayerIsRiding_C_ExecuteUbergraph_GCNL_PlayerIsRiding Parms{};
...
void AGCNL_PlayerIsRiding_C::OnLoopingStartGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents)
{
	...
	Params::AGCNL_PlayerIsRiding_C_OnLoopingStartGeneric Parms{};
...
void AGCNL_PlayerIsRiding_C::OnRemovalGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	Params::AGCNL_PlayerIsRiding_C_OnRemovalGeneric Parms{};
...
void AGCNL_PlayerIsRiding_C::ReceiveTick(float DeltaSeconds)
{
	...
	Params::AGCNL_PlayerIsRiding_C_ReceiveTick Parms{};
...
void AGCNL_PlayerIsRiding_C::ResetJumpParam()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_PlayerIsRiding_C", "ResetJumpParam");
...
bool AGCNL_PlayerIsRiding_C::WhileActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	...
	Params::AGCNL_PlayerIsRiding_C_WhileActive Parms{};
