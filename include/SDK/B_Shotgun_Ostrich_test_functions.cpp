...
void AB_Shotgun_Ostrich_test_C::ExecuteUbergraph_B_Shotgun_Ostrich_test(int32 EntryPoint)
{
	...
	Params::AB_Shotgun_Ostrich_test_C_ExecuteUbergraph_B_Shotgun_Ostrich_test Parms{};
...
void AB_Shotgun_Ostrich_test_C::OnLoadedRockets(int32 NumRocketsLoaded)
{
	...
	Params::AB_Shotgun_Ostrich_test_C_OnLoadedRockets Parms{};
...
void AB_Shotgun_Ostrich_test_C::OnPlayWeaponFireFX(bool bPersistentFire, bool bSecondaryFire)
{
	...
	Params::AB_Shotgun_Ostrich_test_C_OnPlayWeaponFireFX Parms{};
...
void AB_Shotgun_Ostrich_test_C::OnRocketFired(class USceneComponent* AttachToMesh, class FName AttachToSocket)
{
	...
	Params::AB_Shotgun_Ostrich_test_C_OnRocketFired Parms{};

	*reinterpret_cast<void**>(&Parms.AttachToMesh) = reinterpret_cast<void*>(AttachToMesh);
...
void AB_Shotgun_Ostrich_test_C::OnRocketFiringStarted(class USceneComponent* AttachToMesh, class FName AttachToSocket)
{
	...
	Params::AB_Shotgun_Ostrich_test_C_OnRocketFiringStarted Parms{};
...
void AB_Shotgun_Ostrich_test_C::OnRocketLauncherSettle(class USceneComponent* AttachToMesh, class FName AttachToSocket)
{
	...
	Params::AB_Shotgun_Ostrich_test_C_OnRocketLauncherSettle Parms{};
