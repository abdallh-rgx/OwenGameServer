...
void UGA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C::ExecuteUbergraph_GA_NPC_Irwin_Prey_Burt_Charge_RidingHelper(int32 EntryPoint)
{
	...
	Params::UGA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C_ExecuteUbergraph_GA_NPC_Irwin_Prey_Burt_Charge_RidingHelper Parms{};
...
void UGA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C::FireBoostEffectsOnPlayerMulti(class AActor* PlayerTarget)
{
	...
	Params::UGA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C_FireBoostEffectsOnPlayerMulti Parms{};

	*reinterpret_cast<void**>(&Parms.PlayerTarget) = reinterpret_cast<void*>(PlayerTarget);
...
void UGA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C::K2_ActivateAbilityFromEvent(const struct FGameplayEventData& EventData)
{
	...
	Params::UGA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C_K2_ActivateAbilityFromEvent Parms{};
