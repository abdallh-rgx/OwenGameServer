...
// NumValues: 0x0006
enum class EEResonanceRenderMode : uint8
{
	StereoPanning = 0,
...
// NumValues: 0x0005
enum class EERaQualityMode : uint8
{
	STEREO_PANNING = 0,
	BINAURAL_LOW = 1,
	BINAURAL_MEDIUM = 2,
...
// NumValues: 0x0003
enum class EERaSpatializationMethod : uint8
{
	STEREO_PANNING = 0,
	HRTF = 1,
...
// NumValues: 0x0004
enum class EERaDistanceRolloffModel : uint8
{
	LOGARITHMIC = 0,
	LINEAR = 1,
	NONE = 2,
...
// NumValues: 0x0019
enum class EERaMaterialName : uint8
{
	TRANSPARENT_0 = 0,
...
public:
	...
	EERaMaterialName LeftWallMaterial; // 0x0058(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EERaMaterialName RightWallMaterial; // 0x0059(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EERaMaterialName FloorMaterial; // 0x005A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EERaMaterialName CeilingMaterial; // 0x005B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EERaMaterialName FrontWallMaterial; // 0x005C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EERaMaterialName BackWallMaterial; // 0x005D(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
