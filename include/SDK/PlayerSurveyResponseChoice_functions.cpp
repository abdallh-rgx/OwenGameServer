...
void UPlayerSurveyResponseChoice_C::ExecuteUbergraph_PlayerSurveyResponseChoice(int32 EntryPoint)
{
	...
	Params::UPlayerSurveyResponseChoice_C_ExecuteUbergraph_PlayerSurveyResponseChoice Parms{};
...
void UPlayerSurveyResponseChoice_C::GetCurrentButtonBrush(struct FSlateBrush* CurrentBrush)
{
	...
	Params::UPlayerSurveyResponseChoice_C_GetCurrentButtonBrush Parms{};
...
// Parameters:
// EEFortPlayerSurveyResponseChoiceType Type (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPlayerSurveyResponseChoice_C::SetChoiceType(EEFortPlayerSurveyResponseChoiceType Type)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerSurveyResponseChoice_C_SetChoiceType Parms{};
