...
void UXpEverywhereReticleWidget::UpdateRestXP(int32 RestXpRemaining)
{
	...
	Params::UXpEverywhereReticleWidget_UpdateRestXP Parms{};
...
// const EEFortSimulatedXPSize SimulatedXpSize (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UXpEverywhereReticleWidget::UpdateXPAmount(int32 NewAmount, class USoundCue* Cue, const EEFortSimulatedXPSize SimulatedXpSize)
{
	static class UFunction* Func = nullptr;
	...
	Params::UXpEverywhereReticleWidget_UpdateXPAmount Parms{};

	Parms.NewAmount = NewAmount;
	*reinterpret_cast<void**>(&Parms.Cue) = reinterpret_cast<void*>(Cue);
...
void UXpEverywhereReticleWidget::UpdateXPSource(const class FText& NewSourceText)
{
	...
	Params::UXpEverywhereReticleWidget_UpdateXPSource Parms{};
...
void UXpEverywhereLevelUpWidget::OnShowWidget(const int32 NewLevel)
{
	...
	Params::UXpEverywhereLevelUpWidget_OnShowWidget Parms{};
...
void UXpEverywhereBar::OnXpBarInitialized(int32 CurrentXP, int32 CurrentLevel, int32 CurrentRemainingRestXP)
{
	...
	Params::UXpEverywhereBar_OnXpBarInitialized Parms{};
...
void UXpEverywhereBar::OnXpBarUpdated(int32 ShownXP, int32 ShownLevel, int32 NewDesiredXP, int32 NewDesiredLevel, int32 NewRemainingRestXP)
{
	...
	Params::UXpEverywhereBar_OnXpBarUpdated Parms{};
...
int32 UXpEverywhereBar::GetTotalXpRequiredForLevel(const int32 InLevel) const
{
	...
	Params::UXpEverywhereBar_GetTotalXpRequiredForLevel Parms{};
...
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// const class UFortAccoladeItemDefinition* AccoladeDef (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UXpEverywhereAccoladesWidget::OpenWidget(const class UFortAccoladeItemDefinition* AccoladeDef, const int32 XPValue, const class FText& DisplayName, const TSoftObjectPtr<class UTexture2D>& AccoladeLargePreviewImageOverride, const class FText& SimulatedName, const class FText& SimulatedText, const EEFortSimulatedXPSize SimulatedXpSize)
{
	...
	Params::UXpEverywhereAccoladesWidget_OpenWidget Parms{};

	*reinterpret_cast<const void**>(&Parms.AccoladeDef) = reinterpret_cast<const void*>(AccoladeDef);
...
bool UXpEverywhereAccoladesWidget::HasMoreXPEvents() const
{
	...
	Params::UXpEverywhereAccoladesWidget_HasMoreXPEvents Parms{};
