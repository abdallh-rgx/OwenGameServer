...
struct UGAT_GenericTriggeredAbility_C_ExecuteUbergraph_GAT_GenericTriggeredAbility final
{
public:
	UGAT_GenericTriggeredAbility_C_ExecuteUbergraph_GAT_GenericTriggeredAbility() {}
...
#endif
DUMPER7_ASSERTS_UGAT_GenericTriggeredAbility_C_ExecuteUbergraph_GAT_GenericTriggeredAbility;
#if defined(__clang__) || defined(__GNUC__)
...
struct UGAT_GenericTriggeredAbility_C_K2_ActivateAbilityFromEvent final
{
public:
	UGAT_GenericTriggeredAbility_C_K2_ActivateAbilityFromEvent() {}
...
#pragma GCC diagnostic ignored "-Winvalid-offsetof"
#endif
DUMPER7_ASSERTS_UGAT_GenericTriggeredAbility_C_K2_ActivateAbilityFromEvent;
#if defined(__clang__) || defined(__GNUC__)
#pragma GCC diagnostic pop
#endif
