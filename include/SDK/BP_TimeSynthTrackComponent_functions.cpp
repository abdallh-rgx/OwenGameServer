...
void UBP_TimeSynthTrackComponent_C::CalculateMaxClipDuration(TArray<struct FTimeSynth_TrackStemData>& Clips_0, int32* Duration)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_CalculateMaxClipDuration Parms{};
...
void UBP_TimeSynthTrackComponent_C::CheckPlaystate(ETimeSynth_TrackPlayStates Is_In_Play_State, bool* Result)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_CheckPlaystate Parms{};
...
void UBP_TimeSynthTrackComponent_C::ExecuteUbergraph_BP_TimeSynthTrackComponent(int32 EntryPoint)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_ExecuteUbergraph_BP_TimeSynthTrackComponent Parms{};
...
void UBP_TimeSynthTrackComponent_C::FindMixState(class FName Name_0, int32* Array_Index)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_FindMixState Parms{};
...
void UBP_TimeSynthTrackComponent_C::GetMaxClipDuration(int32* MaxClipDuration)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_GetMaxClipDuration Parms{};
...
void UBP_TimeSynthTrackComponent_C::GetMixStateIndexFromName(class FName Name_0, int32* Array_Index)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_GetMixStateIndexFromName Parms{};
...
void UBP_TimeSynthTrackComponent_C::GetPriority(float* Priority)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_GetPriority Parms{};
...
void UBP_TimeSynthTrackComponent_C::GetQuantizationSettings(struct FTimeSynthQuantizationSettings* QuantizationSettings_0)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_GetQuantizationSettings Parms{};
...
void UBP_TimeSynthTrackComponent_C::GetTimeSynthController(class ABP_TimeSynthController_Base_C** TimeSynthController_0)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_GetTimeSynthController Parms{};
...
void UBP_TimeSynthTrackComponent_C::GetTrackID(class FName* TrackID_0)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_GetTrackID Parms{};
...
void UBP_TimeSynthTrackComponent_C::HasTransitionForTrack(class FName TrackID_0, bool* Transition_Found, struct FTimeSynth_TransitionData* Transition_Data)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_HasTransitionForTrack Parms{};
...
// Parameters:
// EETimeSynthEventQuantization QuantizationType (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBP_TimeSynthTrackComponent_C::OnQuantizationBar(EETimeSynthEventQuantization QuantizationType, int32 NumBars, float Beat)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_TimeSynthTrackComponent_C_OnQuantizationBar Parms{};
...
void UBP_TimeSynthTrackComponent_C::OnQuantizationBeat(EETimeSynthEventQuantization QuantizationType, int32 NumBars, float Beat)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_TimeSynthTrackComponent_C_OnQuantizationBeat Parms{};
...
void UBP_TimeSynthTrackComponent_C::QueueTrackStart(bool Is_First_Track)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_QueueTrackStart Parms{};
...
void UBP_TimeSynthTrackComponent_C::QueueTrackStop(bool Play_Outro)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_QueueTrackStop Parms{};
...
void UBP_TimeSynthTrackComponent_C::SetMixStateVolume(class FName MixStateName, float Volume)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_SetMixStateVolume Parms{};
...
void UBP_TimeSynthTrackComponent_C::SetMixStateVolumeByIndex(int32 Index_0, float Volume)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_SetMixStateVolumeByIndex Parms{};
...
void UBP_TimeSynthTrackComponent_C::SetPlaystate(ETimeSynth_TrackPlayStates Is_In_Play_State)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_SetPlaystate Parms{};
...
void UBP_TimeSynthTrackComponent_C::SetTimeSynthController(class ABP_TimeSynthController_Base_C* TimeSynthController_0)
{
	...
	Params::UBP_TimeSynthTrackComponent_C_SetTimeSynthController Parms{};

	*reinterpret_cast<void**>(&Parms.TimeSynthController_0) = reinterpret_cast<void*>(TimeSynthController_0);
