...
void AGCNL_Athena_HidingProp_Teleporting_C::ExecuteUbergraph_GCNL_Athena_HidingProp_Teleporting(int32 EntryPoint)
{
	...
	Params::AGCNL_Athena_HidingProp_Teleporting_C_ExecuteUbergraph_GCNL_Athena_HidingProp_Teleporting Parms{};
...
void AGCNL_Athena_HidingProp_Teleporting_C::OnLoopingStart(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents)
{
	...
	Params::AGCNL_Athena_HidingProp_Teleporting_C_OnLoopingStart Parms{};
...
void AGCNL_Athena_HidingProp_Teleporting_C::OnRemoval(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	Params::AGCNL_Athena_HidingProp_Teleporting_C_OnRemoval Parms{};
