...
class SDK_ALIGN(0x08) UAnimNotifyState_DisablePawnRotation_C final : public UAnimNotifyState
{
public:
	UAnimNotifyState_DisablePawnRotation_C() {}
...
public:
	...
	{
		STATIC_NAME_IMPL(u"AnimNotifyState_DisablePawnRotation_C")
	}
