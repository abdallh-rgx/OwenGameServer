...
void UInputReflectorButton_C::BndEvt__CommonActionWidgetAction_K2Node_ComponentBoundEvent_0_OnInputMethodChanged__DelegateSignature(bool bUsingGamepad)
{
	...
	Params::UInputReflectorButton_C_BndEvt__CommonActionWidgetAction_K2Node_ComponentBoundEvent_0_OnInputMethodChanged__DelegateSignature Parms{};
...
void UInputReflectorButton_C::ExecuteUbergraph_InputReflectorButton(int32 EntryPoint)
{
	...
	Params::UInputReflectorButton_C_ExecuteUbergraph_InputReflectorButton Parms{};
...
void UInputReflectorButton_C::OnActionProgress(float HeldPercent)
{
	...
	Params::UInputReflectorButton_C_OnActionProgress Parms{};
...
void UInputReflectorButton_C::OnTriggeredInputActionChanged(const struct FDataTableRowHandle& NewTriggeredAction)
{
	...
	Params::UInputReflectorButton_C_OnTriggeredInputActionChanged Parms{};
...
void UInputReflectorButton_C::PreConstruct(bool IsDesignTime)
{
	...
	Params::UInputReflectorButton_C_PreConstruct Parms{};
...
void UInputReflectorButton_C::Set_Icon(const struct FSlateBrush& IconBrush_0)
{
	...
	Params::UInputReflectorButton_C_Set_Icon Parms{};
...
void UInputReflectorButton_C::Set_Text(const class FText& ButtonText_0)
{
	...
	Params::UInputReflectorButton_C_Set_Text Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EEHorizontalAlignment ContentAlignment_0 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UInputReflectorButton_C::SetContentAlignment(EEHorizontalAlignment ContentAlignment_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::UInputReflectorButton_C_SetContentAlignment Parms{};
...
void UInputReflectorButton_C::SetControllerStyle(class UClass* ControllerInputStyle_0)
{
	...
	Params::UInputReflectorButton_C_SetControllerStyle Parms{};

	*reinterpret_cast<void**>(&Parms.ControllerInputStyle_0) = reinterpret_cast<void*>(ControllerInputStyle_0);
...
void UInputReflectorButton_C::SetMobileStyle(class UClass* MobileInputStyle_0)
{
	...
	Params::UInputReflectorButton_C_SetMobileStyle Parms{};

	*reinterpret_cast<void**>(&Parms.MobileInputStyle_0) = reinterpret_cast<void*>(MobileInputStyle_0);
...
void UInputReflectorButton_C::SetMouseKeyboardStyle(class UClass* ControllerInputStyle_0)
{
	...
	Params::UInputReflectorButton_C_SetMouseKeyboardStyle Parms{};
...
void UInputReflectorButton_C::SetTextInternal(const class FText& InButtonText)
{
	...
	Params::UInputReflectorButton_C_SetTextInternal Parms{};
...
void UInputReflectorButton_C::ShowIcon(bool bShouldShow)
{
	...
	Params::UInputReflectorButton_C_ShowIcon Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EECommonInputType UsingGamepad (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UInputReflectorButton_C::UpdateStyle(EECommonInputType UsingGamepad)
{
	static class UFunction* Func = nullptr;
	...
	Params::UInputReflectorButton_C_UpdateStyle Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EECommonInputType CommonInputType (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UInputReflectorButton_C::UpdateTextAndStyle(EECommonInputType CommonInputType)
{
	static class UFunction* Func = nullptr;
	...
	Params::UInputReflectorButton_C_UpdateTextAndStyle Parms{};
