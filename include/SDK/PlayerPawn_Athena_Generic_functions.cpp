...
void APlayerPawn_Athena_Generic_C::AnimTrailsNotify(bool bActive)
{
	...
	Params::APlayerPawn_Athena_Generic_C_AnimTrailsNotify Parms{};
...
void APlayerPawn_Athena_Generic_C::AnimTrailsSetup(class UParticleSystem* ParticleSystemReference, class UNiagaraSystem* NiagaraSystemReference, class FName FirstSocketName, class FName SecondSocketName, float Width, class UFXSystemComponent* OverrideParticleComp, class FName OverideFirstSocketName, class FName OverideSecondSocketName)
{
	...
	Params::APlayerPawn_Athena_Generic_C_AnimTrailsSetup Parms{};
...
void APlayerPawn_Athena_Generic_C::Are_the_wind_and_water_RTT_passes_enabled(bool* NewParam)
{
	...
	Params::APlayerPawn_Athena_Generic_C_Are_the_wind_and_water_RTT_passes_enabled Parms{};
...
void APlayerPawn_Athena_Generic_C::CharacterDestroyed(class AActor* DestroyedActor)
{
	...
	Params::APlayerPawn_Athena_Generic_C_CharacterDestroyed Parms{};
...
void APlayerPawn_Athena_Generic_C::Create_and_Duplicate_Effect_Poseable_Skeletal_Mesh(EEFortCustomPartType BodyType, class UMaterialInterface* Material_to_Apply, TArray<class UMaterialInstanceDynamic*>& Empty_MID_Array, int32 TranslucentSortPriority, class UPoseableMeshComponent*& PoseableMesh)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_Create_and_Duplicate_Effect_Poseable_Skeletal_Mesh Parms{};
...
void APlayerPawn_Athena_Generic_C::Create_and_Duplicate_Effect_Skeletal_Meshes_Parent(EEFortCustomPartType BodyType, class USkeletalMeshComponent*& DuplicatedSkeletalMeshComponent, class UMaterialInterface* Material_to_Apply, TArray<class UMaterialInstanceDynamic*>& Empty_MID_Array, int32 TranslucentSortPriority)
{
	...
	Params::APlayerPawn_Athena_Generic_C_Create_and_Duplicate_Effect_Skeletal_Meshes_Parent Parms{};
...
void APlayerPawn_Athena_Generic_C::ExecuteUbergraph_PlayerPawn_Athena_Generic(int32 EntryPoint)
{
	...
	Params::APlayerPawn_Athena_Generic_C_ExecuteUbergraph_PlayerPawn_Athena_Generic Parms{};
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier1(EEGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier1 Parms{};
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier2(EEGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier2 Parms{};
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Abilities_SpookyMist_Loop(EEGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_GameplayCue_Abilities_SpookyMist_Loop Parms{};
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Damage_Shielded(EEGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_GameplayCue_Damage_Shielded Parms{};
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Loop_Shadow_Bomb(EEGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_GameplayCue_Loop_Shadow_Bomb Parms{};
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Shield_Destroyed(EEGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_GameplayCue_Shield_Destroyed Parms{};
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Shield_PotionConsumed(EEGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_GameplayCue_Shield_PotionConsumed Parms{};
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Shield_Reapplied(EEGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_GameplayCue_Shield_Reapplied Parms{};
...
void APlayerPawn_Athena_Generic_C::Hide_VFX_in_Frontend_Hologram(bool isFrontEndHologram)
{
	...
	Params::APlayerPawn_Athena_Generic_C_Hide_VFX_in_Frontend_Hologram Parms{};
...
void APlayerPawn_Athena_Generic_C::K2_OnBecomeViewTarget(class APlayerController* PC)
{
	...
	Params::APlayerPawn_Athena_Generic_C_K2_OnBecomeViewTarget Parms{};

	*reinterpret_cast<void**>(&Parms.PC) = reinterpret_cast<void*>(PC);
...
void APlayerPawn_Athena_Generic_C::K2_OnEndViewTarget(class APlayerController* PC)
{
	...
	Params::APlayerPawn_Athena_Generic_C_K2_OnEndViewTarget Parms{};
...
void APlayerPawn_Athena_Generic_C::Melee_Effect_Color(struct FVector* Melee_Color_Set)
{
	...
	Params::APlayerPawn_Athena_Generic_C_Melee_Effect_Color Parms{};
...
void APlayerPawn_Athena_Generic_C::MeleeSwingLeft(bool First_Left)
{
	...
	Params::APlayerPawn_Athena_Generic_C_MeleeSwingLeft Parms{};
...
void APlayerPawn_Athena_Generic_C::MeleeSwingRight(bool First_Right)
{
	...
	Params::APlayerPawn_Athena_Generic_C_MeleeSwingRight Parms{};
...
void APlayerPawn_Athena_Generic_C::OnDamagePlayEffects(float Damage, const struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, const struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	...
	Params::APlayerPawn_Athena_Generic_C_OnDamagePlayEffects Parms{};
...
void APlayerPawn_Athena_Generic_C::OnDeathServer(float Damage, const struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, const struct FHitResult& HitInfo, class AController* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	...
	Params::APlayerPawn_Athena_Generic_C_OnDeathServer Parms{};
...
void APlayerPawn_Athena_Generic_C::OnLanded(const struct FHitResult& Hit)
{
	...
	Params::APlayerPawn_Athena_Generic_C_OnLanded Parms{};
...
// (Event, Public, BlueprintEvent)
// Parameters:
// EEFortMovementStyle PreviousMovementStyle (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EEFortMovementStyle NewMovementStyle (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void APlayerPawn_Athena_Generic_C::OnMovementStyleChanged(EEFortMovementStyle PreviousMovementStyle, EEFortMovementStyle NewMovementStyle)
{
	static class UFunction* Func = nullptr;
	...
	Params::APlayerPawn_Athena_Generic_C_OnMovementStyleChanged Parms{};
...
void APlayerPawn_Athena_Generic_C::OnWeaponEquipped(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon)
{
	...
	Params::APlayerPawn_Athena_Generic_C_OnWeaponEquipped Parms{};
...
void APlayerPawn_Athena_Generic_C::PlayShieldDestroyedSound(const struct FGameplayCueParameters& GameplayCueParameters)
{
	...
	Params::APlayerPawn_Athena_Generic_C_PlayShieldDestroyedSound Parms{};
...
void APlayerPawn_Athena_Generic_C::SlaveAMeshToTheBody(class USkeletalMeshComponent* Mesh_0, class USkeletalMeshComponent* Master)
{
	...
	Params::APlayerPawn_Athena_Generic_C_SlaveAMeshToTheBody Parms{};
...
void APlayerPawn_Athena_Generic_C::ToggleLandFX(bool NewHidden)
{
	...
	Params::APlayerPawn_Athena_Generic_C_ToggleLandFX Parms{};
...
void APlayerPawn_Athena_Generic_C::GetActorSoundParams(TArray<struct FAudioParameter>* Params_0) const
{
	...
	Params::APlayerPawn_Athena_Generic_C_GetActorSoundParams Parms{};
