...
void UTournamentDateEntry_C::PreConstruct(bool IsDesignTime_PreConstruct)
{
	static class UFunction* Func = nullptr;
	...
	Params::UTournamentDateEntry_C_PreConstruct Parms{};
...
void UTournamentDateEntry_C::ExecuteUbergraph_TournamentDateEntry(int32 EntryPoint)
{
	...
	Params::UTournamentDateEntry_C_ExecuteUbergraph_TournamentDateEntry Parms{};
...
void UTournamentDateEntry_C::EventColor(const struct FFortTournamentDisplayInfo& showdownData)
{
	...
	Params::UTournamentDateEntry_C_EventColor Parms{};
