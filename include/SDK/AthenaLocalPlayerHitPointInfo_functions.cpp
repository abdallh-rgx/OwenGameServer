...
void UAthenaLocalPlayerHitPointInfo_C::ExecuteUbergraph_AthenaLocalPlayerHitPointInfo(int32 EntryPoint)
{
	...
	Params::UAthenaLocalPlayerHitPointInfo_C_ExecuteUbergraph_AthenaLocalPlayerHitPointInfo Parms{};
...
void UAthenaLocalPlayerHitPointInfo_C::OnCreativeModeEnabledChanged(bool bIsEnabled_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAthenaLocalPlayerHitPointInfo_C_OnCreativeModeEnabledChanged Parms{};
...
void UAthenaLocalPlayerHitPointInfo_C::OnCreativeQuickbarEquippedChanged(bool bIsEquipped)
{
	...
	Params::UAthenaLocalPlayerHitPointInfo_C_OnCreativeQuickbarEquippedChanged Parms{};
...
void UAthenaLocalPlayerHitPointInfo_C::OnOvershieldVisibilityChanged()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLocalPlayerHitPointInfo_C", "OnOvershieldVisibilityChanged");
...
void UAthenaLocalPlayerHitPointInfo_C::PreConstruct(bool IsDesignTime)
{
	...
	Params::UAthenaLocalPlayerHitPointInfo_C_PreConstruct Parms{};
...
void UAthenaLocalPlayerHitPointInfo_C::UpdateOvershieldBarVisibility(bool bNewVisible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLocalPlayerHitPointInfo_C", "UpdateOvershieldBarVisibility");

	Params::UAthenaLocalPlayerHitPointInfo_C_UpdateOvershieldBarVisibility Parms{};
