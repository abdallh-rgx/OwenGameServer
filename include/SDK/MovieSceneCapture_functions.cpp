...
// Parameters:
// EEMovieSceneCaptureProtocolState ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

EEMovieSceneCaptureProtocolState UMovieSceneCaptureProtocolBase::GetState() const
{
...
void UUserDefinedCaptureProtocol::ResolveBuffer(class UTexture* Buffer, const struct FCapturedPixelsID& BufferID)
{
	...
	*reinterpret_cast<void**>(&Parms.Buffer) = reinterpret_cast<void*>(Buffer);
