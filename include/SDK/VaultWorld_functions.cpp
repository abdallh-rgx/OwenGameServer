...
void AVaultWorld_C::OnUpdateDisplay(bool bShowFloor, bool bShowEffects)
{
	...
	Params::AVaultWorld_C_OnUpdateDisplay Parms{};
...
void AVaultWorld_C::OnTransitionItemDetails(const bool bShowItemDetails)
{
	...
	Params::AVaultWorld_C_OnTransitionItemDetails Parms{};
...
void AVaultWorld_C::OnTransitionBackground(bool bPlayForward)
{
	...
	Params::AVaultWorld_C_OnTransitionBackground Parms{};
...
void AVaultWorld_C::OnSetupBackground(const class UTexture2D* LoadedBackgroundTexture, const struct FTrackDynamicBackground& BackgroundInfo)
{
	...
	Params::AVaultWorld_C_OnSetupBackground Parms{};

	*reinterpret_cast<const void**>(&Parms.LoadedBackgroundTexture) = reinterpret_cast<const void*>(LoadedBackgroundTexture);
...
void AVaultWorld_C::GetVaultRotator(class AVaultRotator_C** VaultRotator)
{
	...
	Params::AVaultWorld_C_GetVaultRotator Parms{};
...
void AVaultWorld_C::ExecuteUbergraph_VaultWorld(int32 EntryPoint)
{
	...
	Params::AVaultWorld_C_ExecuteUbergraph_VaultWorld Parms{};
