...
void AFortNevadaVehicle::AddPhysicsImpulseToTractorBeamAttachedActor(const struct FVector& Impulse, class FName BoneName, bool bVelChange)
{
	...
	Params::AFortNevadaVehicle_AddPhysicsImpulseToTractorBeamAttachedActor Parms{};
...
void AFortNevadaVehicle::EnablePilotBubbleCollisionOnServer(bool bNewCollisionEnabled)
{
	...
	Params::AFortNevadaVehicle_EnablePilotBubbleCollisionOnServer Parms{};
...
void AFortNevadaVehicle::GetDriverSeatRotationAnimParams(float* OutLeftRight, float* OutForwardBack)
{
	...
	Params::AFortNevadaVehicle_GetDriverSeatRotationAnimParams Parms{};
...
void AFortNevadaVehicle::NativeToggleCockpit(bool bEnable)
{
	...
	Params::AFortNevadaVehicle_NativeToggleCockpit Parms{};
...
void AFortNevadaVehicle::OnAttachedActorDestroyed(class AActor* DestroyedActor)
{
	...
	Params::AFortNevadaVehicle_OnAttachedActorDestroyed Parms{};
...
void AFortNevadaVehicle::OnAttachedActorDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	...
	Params::AFortNevadaVehicle_OnAttachedActorDied Parms{};
...
void AFortNevadaVehicle::OnBatteryRegen(float Newcharge)
{
	...
	Params::AFortNevadaVehicle_OnBatteryRegen Parms{};
...
// Parameters:
// EENevadaFlightStates NewVehicleState (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AFortNevadaVehicle::OnNewVehicleState(EENevadaFlightStates NewVehicleState)
{
	static class UFunction* Func = nullptr;
	...
	Params::AFortNevadaVehicle_OnNewVehicleState Parms{};
...
void AFortNevadaVehicle::OnRep_NevadaState(const struct FNevadaState& PrevState)
{
	...
	Params::AFortNevadaVehicle_OnRep_NevadaState Parms{};
...
// (Final, Native, Protected)
// Parameters:
// const EETractorBeamState PreviousState (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AFortNevadaVehicle::OnRep_TractorBeamState(const EETractorBeamState PreviousState)
{
	static class UFunction* Func = nullptr;
	...
	Params::AFortNevadaVehicle_OnRep_TractorBeamState Parms{};
...
void AFortNevadaVehicle::OnTargetedActorChanged(class AActor* NewTargetedActor)
{
	...
	Params::AFortNevadaVehicle_OnTargetedActorChanged Parms{};

	*reinterpret_cast<void**>(&Parms.NewTargetedActor) = reinterpret_cast<void*>(NewTargetedActor);
...
void AFortNevadaVehicle::OnTractorBeamDeactivated(const struct FVector& LastBeamPosition)
{
	...
	Params::AFortNevadaVehicle_OnTractorBeamDeactivated Parms{};
...
void AFortNevadaVehicle::OnTractorBeamDetached(class AActor* DetachedActor, const struct FVector& LastBeamPosition)
{
	...
	Params::AFortNevadaVehicle_OnTractorBeamDetached Parms{};

	*reinterpret_cast<void**>(&Parms.DetachedActor) = reinterpret_cast<void*>(DetachedActor);
	Parms.LastBeamPosition = std::move(LastBeamPosition);
...
void AFortNevadaVehicle::SetAttachedPawnAddedVelocity(const struct FVector& AddedVelocity)
{
	...
	Params::AFortNevadaVehicle_SetAttachedPawnAddedVelocity Parms{};
...
void AFortNevadaVehicle::SetCannonEnabled(const bool bEnabled)
{
	...
	Params::AFortNevadaVehicle_SetCannonEnabled Parms{};
...
void AFortNevadaVehicle::SetTractorBeamEnabled(const bool bEnabled)
{
	...
	Params::AFortNevadaVehicle_SetTractorBeamEnabled Parms{};
...
class AFortNevadaAudioController* AFortNevadaVehicle::GetAudioController() const
{
	...
	Params::AFortNevadaVehicle_GetAudioController Parms{};
...
float AFortNevadaVehicle::GetBatteryCharge() const
{
	...
	Params::AFortNevadaVehicle_GetBatteryCharge Parms{};
...
float AFortNevadaVehicle::GetBoostChargeProgress() const
{
	...
	Params::AFortNevadaVehicle_GetBoostChargeProgress Parms{};
...
int32 AFortNevadaVehicle::GetBoostChargesAvailable() const
{
	...
	Params::AFortNevadaVehicle_GetBoostChargesAvailable Parms{};
...
float AFortNevadaVehicle::GetBoostChargeTimeRemaining() const
{
	...
	Params::AFortNevadaVehicle_GetBoostChargeTimeRemaining Parms{};
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// EENevadaFlightStates ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

EENevadaFlightStates AFortNevadaVehicle::GetCurrentVehicleState() const
{
	static class UFunction* Func = nullptr;
	...
	Params::AFortNevadaVehicle_GetCurrentVehicleState Parms{};
...
float AFortNevadaVehicle::GetEnergyCanonChargePercent() const
{
	...
	Params::AFortNevadaVehicle_GetEnergyCanonChargePercent Parms{};
...
int32 AFortNevadaVehicle::GetNumRebootsAvailable() const
{
	...
	Params::AFortNevadaVehicle_GetNumRebootsAvailable Parms{};
...
struct FVector AFortNevadaVehicle::GetTractorBeamAttachLocation() const
{
	...
	Params::AFortNevadaVehicle_GetTractorBeamAttachLocation Parms{};
...
bool AFortNevadaVehicle::IsTractorBeamActive() const
{
	...
	Params::AFortNevadaVehicle_IsTractorBeamActive Parms{};
...
bool AFortNevadaVehicle::IsTractorBeamAttached() const
{
	...
	Params::AFortNevadaVehicle_IsTractorBeamAttached Parms{};
...
bool AFortNevadaVehicle::IsTractorBeamDisrupted() const
{
	...
	Params::AFortNevadaVehicle_IsTractorBeamDisrupted Parms{};
...
void AFortNevadaAudioController::CacheReferences(class UFortLayeredAudioComponent* InLayeredAudioComponent)
{
	...
	Params::AFortNevadaAudioController_CacheReferences Parms{};

	*reinterpret_cast<void**>(&Parms.InLayeredAudioComponent) = reinterpret_cast<void*>(InLayeredAudioComponent);
...
void AFortNevadaAudioController::Init(class AFortNevadaVehicle* InVehicle)
{
	...
	Params::AFortNevadaAudioController_Init Parms{};
...
class AFortNevadaVehicle* AFortNevadaAudioController::GetVehicleActor() const
{
	...
	Params::AFortNevadaAudioController_GetVehicleActor Parms{};
