...
void UEventScoreRow_C::SetData(const class FText& Label, int32 Value)
{
	...
	Params::UEventScoreRow_C_SetData Parms{};
...
void UEventScoreRow_C::PreConstruct(bool IsDesignTime_PreConstruct)
{
	static class UFunction* Func = nullptr;
	...
	Params::UEventScoreRow_C_PreConstruct Parms{};
...
void UEventScoreRow_C::ExecuteUbergraph_EventScoreRow(int32 EntryPoint)
{
	...
	Params::UEventScoreRow_C_ExecuteUbergraph_EventScoreRow Parms{};
