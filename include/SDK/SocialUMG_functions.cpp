...
class UUserWidget* USocialListInteractableEntryBase::HandleGetMenuContent()
{
	...
	Params::USocialListInteractableEntryBase_HandleGetMenuContent Parms{};
...
void USocialListInteractableEntryBase::HandleMenuOpenChanged(bool bIsMenuOpen)
{
	...
	Params::USocialListInteractableEntryBase_HandleMenuOpenChanged Parms{};
...
void USocialActionMenu::HandleMenuAnchorOpenChanged(bool bIsOpen)
{
	...
	Params::USocialActionMenu_HandleMenuAnchorOpenChanged Parms{};
...
void USocialInteractionMenu::OnToggleConfirmation(bool bIsVisible)
{
	...
	Params::USocialInteractionMenu_OnToggleConfirmation Parms{};
...
class UWidget* USocialInteractionMenu::GetFirstEntryToCenter() const
{
	...
	Params::USocialInteractionMenu_GetFirstEntryToCenter Parms{};
...
class FName USocialInteractionButton::GetInteractionName() const
{
	...
	Params::USocialInteractionButton_GetInteractionName Parms{};
...
bool USocialInteractionButton::IsPlatformOnlyFriend() const
{
	...
	Params::USocialInteractionButton_IsPlatformOnlyFriend Parms{};
...
class UUserWidget* USocialGroupListEntry::HandleGetMenuContent()
{
	...
	Params::USocialGroupListEntry_HandleGetMenuContent Parms{};
...
bool USocialChatMessageEntry::CanInteract() const
{
	...
	Params::USocialChatMessageEntry_CanInteract Parms{};
...
void USocialChatContainer::DynamicHandleMessageTextCommitted(const class FText& MessageText, EETextCommit CommitMethod)
{
	static class UFunction* Func = nullptr;
	...
	Params::USocialChatContainer_DynamicHandleMessageTextCommitted Parms{};
...
void USocialChatContainer::OnChatOpenChanged(bool bShouldBeOpen)
{
	...
	Params::USocialChatContainer_OnChatOpenChanged Parms{};
