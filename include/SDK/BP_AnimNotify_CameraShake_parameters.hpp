...
struct UBP_AnimNotify_CameraShake_C_Received_Notify final
{
public:
	UBP_AnimNotify_CameraShake_C_Received_Notify() {}
...
#endif
DUMPER7_ASSERTS_UBP_AnimNotify_CameraShake_C_Received_Notify;
#if defined(__clang__) || defined(__GNUC__)
