...
// Parameters:
// const struct FFortWorldMarkerData& MarkerData_OnSetupMarker (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void AB_AthenaPlayerMarker_WithCustomization_C::OnSetupMarker(const struct FFortWorldMarkerData& MarkerData_OnSetupMarker)
{
	static class UFunction* Func = nullptr;
	...
	Params::AB_AthenaPlayerMarker_WithCustomization_C_OnSetupMarker Parms{};

	Parms.MarkerData_OnSetupMarker = std::move(MarkerData_OnSetupMarker);
...
void AB_AthenaPlayerMarker_WithCustomization_C::OnLoaded_8A042AD24DC8A8C0E9D8E0B4BF3B6C37(TSubclassOf<class UObject> Loaded)
{
	...
	Params::AB_AthenaPlayerMarker_WithCustomization_C_OnLoaded_8A042AD24DC8A8C0E9D8E0B4BF3B6C37 Parms{};
...
void AB_AthenaPlayerMarker_WithCustomization_C::ExecuteUbergraph_B_AthenaPlayerMarker_WithCustomization(int32 EntryPoint)
{
	...
	Params::AB_AthenaPlayerMarker_WithCustomization_C_ExecuteUbergraph_B_AthenaPlayerMarker_WithCustomization Parms{};
