...
// Parameters:
// bool bShowProgression_OnUnlockingInfoSet (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaLockedStyleNotification_C::OnUnlockingInfoSet(bool bShowProgression_OnUnlockingInfoSet)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAthenaLockedStyleNotification_C_OnUnlockingInfoSet Parms{};

	Parms.bShowProgression_OnUnlockingInfoSet = bShowProgression_OnUnlockingInfoSet;
...
void UAthenaLockedStyleNotification_C::ExecuteUbergraph_AthenaLockedStyleNotification(int32 EntryPoint)
{
	...
	Params::UAthenaLockedStyleNotification_C_ExecuteUbergraph_AthenaLockedStyleNotification Parms{};
