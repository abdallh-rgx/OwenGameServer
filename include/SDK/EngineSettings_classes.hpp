...
public:
	...
	{
		STATIC_NAME_IMPL(u"HudSettings")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"GeneralProjectSettings")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"GeneralEngineSettings")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"GameSessionSettings")
	}
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"GameNetworkManagerSettings")
	}
...
public:
	...
	EETwoPlayerSplitScreenType TwoPlayerSplitscreenLayout; // 0x0051(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EEThreePlayerSplitScreenType ThreePlayerSplitscreenLayout; // 0x0052(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EEFourPlayerSplitScreenType FourPlayerSplitscreenLayout; // 0x0053(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	// NumParams(1) | ParamSize(0x8) | NativeExecOffset(0x7B6EE18)
	...
	// NumParams(1) | ParamSize(0x1) | NativeExecOffset(0x7B6ED68)
	...
	// NumParams(1) | ParamSize(0x1) | NativeExecOffset(0x7B6ED30)
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"GameMapsSettings")
	}
...
public:
	...
	struct CoreUObject::FColor InputColor; // 0x0058(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject::FColor HistoryColor; // 0x005C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject::FColor AutoCompleteCommandColor; // 0x0060(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject::FColor AutoCompleteCVarColor; // 0x0064(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject::FColor AutoCompleteFadedColor; // 0x0068(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(u"ConsoleSettings")
	}
