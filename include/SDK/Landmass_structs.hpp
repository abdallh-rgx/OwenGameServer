...
// NumValues: 0x0003
enum class EEBrushFalloffMode : uint8
{
	Angle = 0,
	Width = 1,
...
// NumValues: 0x0004
enum class EEBrushBlendType : uint8
{
	AlphaBlend = 0,
	Min = 1,
	Max = 2,
...
public:
	...
	EEBrushFalloffMode FalloffMode; // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	EEBrushBlendType BlendMode; // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
