...
void UBP_SurfaceTypeSoundComponent_C::ExecuteUbergraph_BP_SurfaceTypeSoundComponent(int32 EntryPoint)
{
	...
	Params::UBP_SurfaceTypeSoundComponent_C_ExecuteUbergraph_BP_SurfaceTypeSoundComponent Parms{};
...
void UBP_SurfaceTypeSoundComponent_C::PlaySound(const struct FVector& Location_0)
{
	...
	Params::UBP_SurfaceTypeSoundComponent_C_PlaySound Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EEPhysicalSurface SurfaceType_0 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AActor* Actor (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_SurfaceTypeSoundComponent_C::SetSurfaceType(EEPhysicalSurface SurfaceType_0, class AActor* Actor)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_SurfaceTypeSoundComponent_C_SetSurfaceType Parms{};
