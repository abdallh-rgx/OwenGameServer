...
void UItemInfoHeaderWidget_C::UpdateNameText(class UFortItemDefinition* ItemDefinition, int32 Quantity)
{
	static class UFunction* Func = nullptr;
	...
	Params::UItemInfoHeaderWidget_C_UpdateNameText Parms{};
...
void UItemInfoHeaderWidget_C::UpdateColorRarity(const struct FFortColorPalette& Colors)
{
	...
	Params::UItemInfoHeaderWidget_C_UpdateColorRarity Parms{};
...
void UItemInfoHeaderWidget_C::Update(class UFortItemDefinition* ItemDefinition, int32 Quantity)
{
	static class UFunction* Func = nullptr;
	...
	Params::UItemInfoHeaderWidget_C_Update Parms{};
...
// EEFortItemCardSize CardSize (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UItemInfoHeaderWidget_C::Setup(bool ShouldShowCard, EEFortItemCardSize CardSize, bool ShouldShowDetails, bool ShouldShowDescription)
{
	static class UFunction* Func = nullptr;
	...
	Params::UItemInfoHeaderWidget_C_Setup Parms{};
...
void UItemInfoHeaderWidget_C::SetRemainingQuantity(bool ShouldShowRemainingQuantity, int32 NewRemainingQuantity)
{
	...
	Params::UItemInfoHeaderWidget_C_SetRemainingQuantity Parms{};
...
void UItemInfoHeaderWidget_C::SetLocked(bool ShouldShowLocked, const class FText& LockReason)
{
	...
	Params::UItemInfoHeaderWidget_C_SetLocked Parms{};
...
void UItemInfoHeaderWidget_C::OverrideHeaderAndDescription(const class FText& Header, const class FText& Description, const class FText& ItemType, bool bUseAlternateHeaderBG, EEFortRarity Rarity)
{
	static class UFunction* Func = nullptr;
	...
	Params::UItemInfoHeaderWidget_C_OverrideHeaderAndDescription Parms{};
...
void UItemInfoHeaderWidget_C::HasValidItemDefinition(bool* HasValidDescription)
{
	...
	Params::UItemInfoHeaderWidget_C_HasValidItemDefinition Parms{};
...
class FText UItemInfoHeaderWidget_C::GetAlternateNameForItem(class UFortItemDefinition* ItemDef)
{
	...
	Params::UItemInfoHeaderWidget_C_GetAlternateNameForItem Parms{};

	*reinterpret_cast<void**>(&Parms.ItemDef) = reinterpret_cast<void*>(ItemDef);
...
void UItemInfoHeaderWidget_C::ExecuteUbergraph_ItemInfoHeaderWidget(int32 EntryPoint)
{
	...
	Params::UItemInfoHeaderWidget_C_ExecuteUbergraph_ItemInfoHeaderWidget Parms{};
