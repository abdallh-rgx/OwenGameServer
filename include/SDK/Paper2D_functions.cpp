...
bool UPaperSpriteComponent::SetSprite(class UPaperSprite* NewSprite)
{
	...
	*reinterpret_cast<void**>(&Parms.NewSprite) = reinterpret_cast<void*>(NewSprite);
...
struct FSlateBrush UPaperSpriteBlueprintLibrary::MakeBrushFromSprite(class UPaperSprite* Sprite, int32 Width, int32 Height)
{
	...
	*reinterpret_cast<void**>(&Parms.Sprite) = reinterpret_cast<void*>(Sprite);
	Parms.Width = Width;
	Parms.Height = Height;
...
int32 UPaperGroupedSpriteComponent::AddInstance(const struct CoreUObject::FTransform& Transform, class UPaperSprite* Sprite, bool bWorldSpace, const struct FLinearColor& Color)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// int32 InstanceIndex (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct CoreUObject::FTransform& NewInstanceTransform (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// bool bWorldSpace (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool bMarkRenderStateDirty (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool bTeleport (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UPaperGroupedSpriteComponent::UpdateInstanceTransform(int32 InstanceIndex, const struct CoreUObject::FTransform& NewInstanceTransform, bool bWorldSpace, bool bMarkRenderStateDirty, bool bTeleport)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// int32 InstanceIndex (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject::FTransform* OutInstanceTransform (Parm, OutParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// bool bWorldSpace (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool ReturnValue (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UPaperGroupedSpriteComponent::GetInstanceTransform(int32 InstanceIndex, struct CoreUObject::FTransform* OutInstanceTransform, bool bWorldSpace) const
{
	static class UFunction* Func = nullptr;
...
void UPaperFlipbookComponent::OnRep_SourceFlipbook(class UPaperFlipbook* OldFlipbook)
{
	...
	*reinterpret_cast<void**>(&Parms.OldFlipbook) = reinterpret_cast<void*>(OldFlipbook);
...
bool UPaperFlipbookComponent::SetFlipbook(class UPaperFlipbook* NewFlipbook)
{
	...
	*reinterpret_cast<void**>(&Parms.NewFlipbook) = reinterpret_cast<void*>(NewFlipbook);
...
struct CoreUObject::FTransform UTileMapBlueprintLibrary::GetTileTransform(const struct FPaperTileInfo& Tile)
{
	static class UFunction* Func = nullptr;
...
struct FPaperTileInfo UTileMapBlueprintLibrary::MakeTile(int32 TileIndex, class UPaperTileSet* TileSet, bool bFlipH, bool bFlipV, bool bFlipD)
{
	...
	*reinterpret_cast<void**>(&Parms.TileSet) = reinterpret_cast<void*>(TileSet);
	Parms.bFlipH = bFlipH;
	Parms.bFlipV = bFlipV;
	Parms.bFlipD = bFlipD;
...
bool UPaperTileMapComponent::SetTileMap(class UPaperTileMap* NewTileMap)
{
	...
	*reinterpret_cast<void**>(&Parms.NewTileMap) = reinterpret_cast<void*>(NewTileMap);
