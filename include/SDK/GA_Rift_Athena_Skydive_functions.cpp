...
void UGA_Rift_Athena_Skydive_C::ExecuteUbergraph_GA_Rift_Athena_Skydive(int32 EntryPoint)
{
	...
	Params::UGA_Rift_Athena_Skydive_C_ExecuteUbergraph_GA_Rift_Athena_Skydive Parms{};
...
void UGA_Rift_Athena_Skydive_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	Params::UGA_Rift_Athena_Skydive_C_K2_OnEndAbility Parms{};
...
void UGA_Rift_Athena_Skydive_C::None_0(class AActor* DestroyedActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Rift_Athena_Skydive_C", "None");

	Params::UGA_Rift_Athena_Skydive_C_None Parms{};
...
void UGA_Rift_Athena_Skydive_C::OnPawnEnteredWater(class AFortPlayerPawn* FortPlayerPawn)
{
	...
	Params::UGA_Rift_Athena_Skydive_C_OnPawnEnteredWater Parms{};
...
void UGA_Rift_Athena_Skydive_C::OnPawnLanded(const struct FHitResult& Hit)
{
	...
	Params::UGA_Rift_Athena_Skydive_C_OnPawnLanded Parms{};
