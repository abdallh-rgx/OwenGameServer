...
void UAthenaStormSurgeWidget_C::ExecuteUbergraph_AthenaStormSurgeWidget(int32 EntryPoint)
{
	...
	Params::UAthenaStormSurgeWidget_C_ExecuteUbergraph_AthenaStormSurgeWidget Parms{};
...
void UAthenaStormSurgeWidget_C::OnStartDisplaying(const class FText& TitleText)
{
	...
	Params::UAthenaStormSurgeWidget_C_OnStartDisplaying Parms{};
...
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// const class FText& ThresholdText_0 (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// EEStormSurgeThresholdType ThresholdType (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaStormSurgeWidget_C::OnUpdateThresholdDisplay(const class FText& ThresholdText_0, EEStormSurgeThresholdType ThresholdType)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAthenaStormSurgeWidget_C_OnUpdateThresholdDisplay Parms{};
...
void UAthenaStormSurgeWidget_C::PreConstruct(bool IsDesignTime)
{
	...
	Params::UAthenaStormSurgeWidget_C_PreConstruct Parms{};
